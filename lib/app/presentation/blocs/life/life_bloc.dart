...
class LifeBloc extends Bloc<LifeEvent, LifeState> {
  ...
  Future<void> _onRefreshLife(RefreshLifeEvent event, Emitter<LifeState> emit) async {
    try {
  ...
  Future<void> _onUpdateLife(UpdateLifeEvent event, Emitter<LifeState> emit) async {
