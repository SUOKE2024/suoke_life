...
class RecommendationService extends GetxService {
  ...
  Future<List<Map<String, dynamic>>> _scoreContent(
    ...
    try {
      for (final content in candidates) {
        content['score'] = await _calculateContentScore(content, interests);
      }
      return candidates;
    } catch (e) {
      rethrow;
  ...
  Future<double> _calculateContentScore(Map<String, dynamic> content, List<String> interests) async {
    try {
      // TODO: 实现内容评分计算
      return 0.0;
    } catch (e) {
