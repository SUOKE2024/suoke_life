...
class AIService {
  ...
  Future<String> getAIResponse(String message, {String model = "ep-20241024122905-r8xsl"}) async {
    // 使用 Process.run 调用 Python 脚本
    final scriptPath = path.join(Directory.current.path, 'scripts', 'ai_service.py');
