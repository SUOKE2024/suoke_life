...
- **智能体代理小艾（xiaoai）**：索克生活APP首页（聊天频道）版主，为用户提供语音引导、交互、问诊，以及包括导盲、导医、手语识别等无障碍服务，统筹协调望诊、闻诊、问诊、切诊、算诊服务。
  - **核心功能**：
    - 实时语音交互与多语种支持（含方言识别）
    - 中医望诊面色分析与舌诊图像处理
    - 智能问诊系统（体质筛查、症状评估、健康咨询）、算诊
    - 医疗记录自动整理与健康档案管理
...
1.  **小艾（医患交互与四诊协调核心）**：
    - **市场对接**：主要对应"医生助手"与"AI护士"市场。通过语音交互、多模态感知（望闻问切算辅助）及智能问诊，旨在减轻中医等医生的行政负担，提升初步诊断信息采集效率和标准化水平，并提供患者引导与健康咨询。
