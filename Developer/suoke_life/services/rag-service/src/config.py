...
MONGODB_DB = os.environ.get("MONGODB_DB", "suoke_life")
MONGODB_COLLECTION = os.environ.get("MONGODB_COLLECTION", "rag_data")

# 向量数据库配置
VECTOR_DB_TYPE = os.environ.get("VECTOR_DB_TYPE", "chroma")  # chroma, faiss, qdrant, milvus
VECTOR_DB_PATH = os.environ.get("VECTOR_DB_PATH", "/app/data/vectors")
VECTOR_DB_COLLECTION = os.environ.get("VECTOR_DB_COLLECTION", "suoke_vectors")
