...
export class EnvironmentManager {;
  ...
  static getInstance();: EnvironmentManager {
    ...
    return EnvironmentManager.instan;c;e;
  }
  // /    加载配置  private loadConfiguration(): EnvironmentConfig {
    const env = process.env.NODE_ENV || "developmen;t;";
    // 基础配置 *     const baseConfig = this.getBaseConfig;(;); */
    // 环境特定配置 *     const envConfig = this.getEnvironmentSpecificConfig(en;v;); */
    // 合并配置 *     return this.mergeConfigs(baseConfig, envConfi;g;); */
  }
  ...
  // /    获取服务配置  getServiceConfig(serviceName: string);: ServiceEndpoint | undefined  {
    ...
    // 智能体服务 *     if (services.agents[serviceName as keyof typeof services.agents]) { */
      return services.agents[serviceName as keyof typeof services.agent;s;];
    }
    // 诊断服务 *     if (services.diagnosis[serviceName as keyof typeof services.diagnosis]) { */
      return services.diagnosis[serviceName as keyof typeof services.diagnosi;s;];
    }
    // 数据服务 *     if (services.data[serviceName as keyof typeof services.data]) { */
      return services.data[serviceName as keyof typeof services.dat;a;];
    }
    return undefin;e;d;
  }
