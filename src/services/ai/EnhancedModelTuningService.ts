...
import { ModelTrainingService, TrainingConfig } from "./modelTrainingService";""/;"/g"/;
...
// 过滤配置/;,/g/;
export interface FilterConfig {type: string,;}}
}
  parameters: Record<string, any>;}
}

// 转换配置/;,/g/;
export interface TransformationConfig {type: string,;}}
}
  parameters: Record<string, any>;}
}
...
// 精调结果/;,/g/;
export interface TuningResult {modelId: string,';,}config: TuningConfig,';,'';
...
// 精调任务/;,/g/;
export interface TuningTask {id: string,';,}config: TuningConfig,';,'';
...
private async generateSyntheticData(source: string): Promise<any[]> {}}
  ...
  /* 据 *//;/g/;
   *//;,/g/;
private async preprocessData(data: any[], config: PreprocessingConfig): Promise<any[]> {let processedData = [...data];}    // 标准化/;,/g/;
