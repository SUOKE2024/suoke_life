...
// 重连配置接口 * export interface ReconnectConfig {/;,}enabled: boolean,;,/g,/;
  maxAttempts: number,;
delay: number,;
...
// 消息队列项接口 * interface QueuedMessage {/;,}message: WebSocketMessage,;,/g,/;
  timestamp: number,;
}
}
...
if (this.ws) {}}
  ...
  // 重新订阅所有频道  private resubscribeAll(): void {}/;,/g/;
...
this.emit("stateChange", { state, previousState });";"";
  ...
  // 生成消息ID  private generateMessageId(): string {}/;,/g/;
