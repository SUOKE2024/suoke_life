...
export class AIModelOptimizationService {
  ...
  public async optimizeModel(
    ...
    try {
      ...
      // 更新模型信息
      const optimizedModel: ModelInfo = {
        ...model,
      ...
      console.log(`模型 ${model.name} 优化完成`);
  ...
  public getOptimizationStatus(): {
    ...
    return {
      ...
      currentQueue: [...this.optimizationQueue]
    };
  }
