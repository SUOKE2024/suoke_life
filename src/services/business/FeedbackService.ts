import {ImprovementMetrics} fromroductImprovement,
}
    UserFeedback};
} from "../../types/business";
/* 化 */
...
status?: UserFeedback['status'];')'
  ...
  }): Promise<UserFeedback[]> {try {}      // 模拟反馈数据
...
resolutionRate: number,
    ...
    const avgResolutionTime = number; // 小时}
...
status?: ProductImprovement['status'];')'
  ...
  }): Promise<ProductImprovement[]> {try {}      // 模拟产品改进建议数据
