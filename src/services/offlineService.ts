  ...
  async preloadCriticalData(): Promise<void> {
    ...
    try {
      ...
      const criticalEndpoints = [
        { service: 'USER', endpoint: '/users/profile' },
        { service: 'USER', endpoint: '/users/settings' },
        { service: 'HEALTH_DATA', endpoint: '/health-data/recent' },
        { service: 'AGENTS', endpoint: '/agents/status' },
      ];
