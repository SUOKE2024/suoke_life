...
export class AgentApiService {;
  ...
  public static getInstance(config?: AgentApiConfig): AgentApiService  {
    ...
    return AgentApiService.instan;c;e;
  }
  // /    小艾智能体API - 首页聊天频道版主 & 四诊协调智能体  public async xiaoaiChat(request: ChatRequest): Promise<ApiResponse<AgentResponse />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.XIAOAI].apiEndpoint}/cha;t;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
  ...
  // /    小艾四诊协调API  public async xiaoaiFourDiagnosis(request: DiagnosisRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.XIAOAI].apiEndpoint}/four-diagnosi;s;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.XIAOAI,
  ...
  // /    小克智能体API - SUOKE频道版主 & 服务管理智能体  public async xiaokeServiceManagement(request: ServiceRequest): Promise<ApiResponse<AgentResponse />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.XIAOKE].apiEndpoint}/service-managemen;t;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
  ...
  // /    小克农产品溯源API  public async xiaokeProductTraceability(request: ServiceRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.XIAOKE].apiEndpoint}/product-traceabilit;y;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.XIAOKE,
  ...
  // /    小克第三方API集成  public async xiaokeThirdPartyIntegration(request: ServiceRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.XIAOKE].apiEndpoint}/third-party-integratio;n;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.XIAOKE,
  ...
  // /    老克智能体API - 探索频道版主 & 知识传播智能体  public async laokeKnowledgeRetrieval(request: ServiceRequest): Promise<ApiResponse<AgentResponse />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.LAOKE].apiEndpoint}/knowledge-retrieva;l;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
  ...
  // /    老克游戏NPC API  public async laokeGameNPC(request: ServiceRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.LAOKE].apiEndpoint}/game-np;c;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.LAOKE,
  ...
  // /    老克内容管理API  public async laokeContentManagement(request: ServiceRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.LAOKE].apiEndpoint}/content-managemen;t;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.LAOKE,
  ...
  // /    索儿智能体API - LIFE频道版主 & 生活健康管理智能体  public async soerLifestyleManagement(request: HealthDataRequest): Promise<ApiResponse<AgentResponse />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.SOER].apiEndpoint}/lifestyle-managemen;t;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
  ...
  // /    索儿传感器数据整合API  public async soerSensorDataIntegration(request: HealthDataRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.SOER].apiEndpoint}/sensor-data-integratio;n;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.SOER,
  ...
  // /    索儿情感支持API  public async soerEmotionalSupport(request: ServiceRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.SOER].apiEndpoint}/emotional-suppor;t;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.SOER,
  ...
  // /    索儿个性化养生计划API  public async soerWellnessPlan(request: ServiceRequest): Promise<ApiResponse<any />>  {
    const endpoint = `${AGENT_CONFIGS[AgentType.SOER].apiEndpoint}/wellness-pla;n;`/    return this.makeRequest(endpoint, {
      method: 'POST',
      body: JSON.stringify({
        ...request,
        agentType: AgentType.SOER,
