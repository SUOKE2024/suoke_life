...
def to_fhir_observation_temperature(user_id: str, value: float, unit: str = "Celsius", effective_time: str = None) -> Dict[str, Any]:
    return {
...
def validate_fhir_observation(obs: Dict[str, Any]) -> bool:
    ...
    return all(field in obs for field in required_fields) and obs["resourceType"] == "Observation"
