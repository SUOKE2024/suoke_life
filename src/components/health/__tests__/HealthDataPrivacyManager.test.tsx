...
import HealthDataPrivacyManager from "../HealthDataPrivacyManager";""/;"/g"/;
...
';,'';
describe("HealthDataPrivacyManager", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <HealthDataPrivacyManager  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('healthdataprivacymanager')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <HealthDataPrivacyManager {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
