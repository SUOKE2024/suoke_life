...
import { useNavigation } from "@react-navigation/native"/importReact from "react";
import { usePerformanceMonitor } from '../hooks/usePerformanceMonitor';/const NavigationTest: React.FC = () => {
