...
// 推荐集成react-native-voice或expo-speech * *  * *// import Voice from '@react-native-voice* * voice'; * */// export const AgentVoiceInput: React.FC<AgentVoiceInputProps  /> void;/}> = ({ onResult }) => {;
