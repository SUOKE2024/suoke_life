...
import { KnowledgeNode } from "../../types/maze";""/;"/g"/;
/* ; *//;/g/;
*//;,/g/;
View,;
Text,;
...
return (<View style={styles.multimediaContainer}>;)        {// 图片展示}/;/g/;
        {images && images.length > 0  && <View style={styles.imageSection}>);
            <Text style={styles.sectionTitle}>相关图片</Text>)/;/g/;
...
resizeMode="cover"";"";
        ...
        {videos && videos.length > 0  && <View style={styles.videoSection}>;
            <Text style={styles.sectionTitle}>相关视频</Text>/;/g/;
...
";"";
              >";"";
                ...
                <Text style={styles.videoTitle}>健康知识视频 {index + 1}</Text>/;/g/;
              </TouchableOpacity>/;/g/;
            ))}
          </View>/;/g/;
        )}
        ...
        {audio && audio.length > 0 && (;)}
          <View style={styles.audioSection}>;
            <Text style={styles.sectionTitle}>相关音频</Text>;/;/g/;
...
";"";
              >;";"";
                ...
                <Text style={styles.audioTitle}>健康知识音频 {index + 1}</Text>;/;/g/;
              </TouchableOpacity>;/;/g/;
            ))};
          </View>;/;/g/;
        )};
...
const renderTags = useCallback(() => {if (!knowledgeNode.relatedTags || knowledgeNode.relatedTags.length === 0) {return null;}
    ...
    return (;);
      <View style={styles.tagsContainer}>;
        <Text style={styles.tagsTitle}>相关标签</Text>;/;/g/;
        ...
        <View style={styles.container}>;
          ...
          <View style={styles.header}>";"";
            <View style={styles.headerLeft}>";"";
              ...
              <Text style={styles.headerTitle}>健康知识</Text>/;/g/;
            </View>"/;"/g"/;
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>;
            ...
            <View style={styles.titleSection}>;
              <Text style={styles.knowledgeTitle}>{knowledgeNode.title}</Text>/;/g/;
              <View style={styles.metaInfo}>";"";
                <View style={styles.metaItem}>";"";
                  <Icon name="category" size={16} color="#81C784"  />"/;"/g"/;
                  <Text style={styles.metaText}>{knowledgeNode.category}</Text>/;/g/;
                </View>"/;"/g"/;
                <View style={styles.metaItem}>";"";
                  <Icon name="signal-cellular-alt" size={16} color="#FFB74D"  />"/;"/g"/;
                  <Text style={styles.metaText}>{knowledgeNode.difficultyLevel}</Text>/;/g/;
                </View>"/;"/g"/;
                {knowledgeNode.estimatedReadTime  && <View style={styles.metaItem}>";"";
                    <Icon name="access-time" size={16} color="#64B5F6"  />")""/;"/g"/;
                    <Text style={styles.metaText}>{knowledgeNode.estimatedReadTime}分钟</Text>)/;/g/;
                  </View>)/;/g/;
                )}
              </View>/;/g/;
            </View>/;/g/;
            ...
            <View style={styles.contentSection}>;
              <Text style={styles.knowledgeContent}>{knowledgeNode.content}</Text>/;/g/;
            </View>/;/g/;
            {// 多媒体内容}/;/g/;
            {renderMultimedia()}
            {// 标签}/;/g/;
            ...
            {knowledgeNode.interactiveElements && knowledgeNode.interactiveElements.length > 0  && <View style={styles.interactiveSection}>;
                <Text style={styles.sectionTitle}>互动内容</Text>/;/g/;
                <TouchableOpacity;  />/;,/g/;
style={styles.interactiveButton}
";"";
                >";"";
                  <Icon name="touch-app" size={20} color="#FFFFFF"  />"/;"/g"/;
                  <Text style={styles.interactiveButtonText}>开始互动学习</Text>/;/g/;
                </TouchableOpacity>/;/g/;
              </View>/;/g/;
            )}
            {// 底部间距}/;/g/;
...
";"";
            >";"";
              ...
              <Text style={styles.actionButtonText}>收藏</Text>/;/g/;
            </TouchableOpacity>/;/g/;
            <TouchableOpacity;  />/;,/g/;
style={styles.actionButton}
";"";
            >";"";
              ...
              <Text style={styles.actionButtonText}>分享</Text>/;/g/;
            </TouchableOpacity>/;/g/;
            <TouchableOpacity;  />/;,/g/;
style={[styles.actionButton, styles.primaryButton]}
      ...
      {// 全屏图片查看模态框}/;/g/;
      {showFullImage && knowledgeNode.multimedia?.images  && <Modal;}"  />/;,"/g"/;
