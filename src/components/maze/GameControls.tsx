...
import { Direction, GameSettings } from "../../types/maze";""/;"/g"/;
/* ; *//;/g/;
*//;,/g/;
View,;
Text,;
...
const  GameControls: React.FC<GameControlsProps> = ({)onMove,);,}disabled,);
  ...
  /* 下 *//;/g/;
  *//;,/g/;
const handlePressIn = useCallback((direction: Direction) => {if (disabled) return;}    // 触觉反馈/;,/g/;
...
activeOpacity={0.8};';'';
        >;';'';
          ...
          <Text style={styles.buttonLabel}>{label}</Text>;/;/g/;
        </TouchableOpacity>;/;/g/;
      </Animated.View>;/;/g/;
    );
  };
return (<View style={styles.container}>;)      {// 控制说明}/;/g/;
...
styles.southButton,;
      ...
      <View style={styles.hintContainer}>';'';
        <View style={styles.hintItem}>;';'';
          ...
          <Text style={styles.hintText}>点击移动</Text>;/;/g/;
        </View>;"/;"/g"/;
        <View style={styles.hintItem}>;";"";
          <Icon name="swipe" size={16} color="#81C784"  />;"/;"/g"/;
          <Text style={styles.hintText}>滑动控制</Text>;/;/g/;
        </View>;/;/g/;
        {gameSettings?.vibrationEnabled && (;)}";"";
          <View style={styles.hintItem}>;";"";
            <Icon name="vibration" size={16} color="#81C784"  />;"/;"/g"/;
            <Text style={styles.hintText}>触觉反馈</Text>;/;/g/;
          </View>;/;/g/;
        )};
      </View>;/;/g/;
    </View>;/;/g/;
