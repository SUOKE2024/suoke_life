...
const GameControls: React.FC<GameControlsProps> = ({
  ...
  const buttonScales = useRef({
    [Direction.NORTH]: new Animated.Value(1),
    [Direction.EAST]: new Animated.Value(1),
    [Direction.SOUTH]: new Animated.Value(1),
    [Direction.WEST]: new Animated.Value(1),
  }).current;
    ...
    return (
      <Animated.View
        style={[
          ...
          style,
          {
            transform: [{ scale: buttonScales[direction] }],
