...
export const BenchmarkCreator: React.FC<BenchmarkCreatorProps> = ({
  ...
  const benchmarkTypes = [;
    { id: 'tcm_diagnosis', name: '中医诊断评测', description: '评测中医诊断准确性' },{ id: 'agent_collaboration', name: '智能体协作评测', description: '评测多智能体协作能力' },{ id: 'privacy_security', name: '隐私安全评测', description: '评测数据隐私保护能力' },{ id: 'performance_stress', name: '性能压力评测', description: '评测系统性能和稳定性' },{ id: 'user_experience', name: '用户体验评测', description: '评测用户交互体验' },{ id: 'custom', name: '自定义评测', description: '创建自定义评测任务' };
  ];
  ...
  const testDataTemplates = {
    ...
    privacy_security: [
      ...
      {user_journey: 'health_assessment',expected_completion_time: 300,usability_score_threshold: 4.0;
      };
    ];
  };
...
const styles = StyleSheet.create({
  ...
  },pluginOptionSelected: {borderColor: '#2196F3',backgroundColor: '#e3f2fd';
  },pluginOptionText: {fontSize: 14,color: '#333';
  },pluginOptionTextSelected: {color: '#2196F3',fontWeight: '500';
  };
}); 
