...
const userId = stringonResult?: (result: RAGQueryResponse) => void;
}
...
return (<View style={styles.container}>;)      <Text style={styles.title}>RAG智能查询</Text>
      {// 任务类型选择}
