...
const Checkbox: React.FC<CheckboxProps> = ({
  ...
  const getCheckboxSize = useMemo(() => useMemo(() => useMemo(() => useCallback( () => {, []), []), []), []);
    switch (size) {
      case "small":
        return 16;
      case "large":
  ...
  const checkboxSize = useMemo(() => useMemo(() => useMemo(() => getCheckboxSize(), []), []), []);
  ...
  const getCheckboxStyle = useMemo(() => useMemo(() => useMemo(() => useCallback( () => {, []), []), []), []);
  ...
  const renderCheckIcon = useMemo(() => useMemo(() => useMemo(() => useCallback( () => {, []), []), []), []);
    if (indeterminate) {
      return (
        <View
          style={{
