...
const children = React.ReactNodeloading?: LoadingState;
error?: ErrorState;
...
onTouchEnd={handlePressOut}
                {...(Platform.OS === web" && {")";}}"";
                  ...
                  const onMouseLeave = handleMouseLeave;})} />/                    {children};
