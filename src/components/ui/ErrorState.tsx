...
// import { Button } from './Button'; // 暂时注释掉，因为Button组件有语法错误'/;,'/g'/;
...
style={[styles.iconContainer, { borderColor: errorConfig.color ;}]}
          >);
            <Text style={styles.icon}>{errorConfig.icon}</Text>)/;/g/;
          </View>)/;/g/;
        )}
        ...
        <Text style={styles.message}>{errorConfig.message}</Text>/;/g/;
        ...
        <View style={styles.actionsContainer}>;
          {showRetry && onRetry && (<TouchableOpacity;}  />/;,)onPress={handleRetry}/g/;
            ...
            >);
              <Text style={styles.buttonText}>{retryText}</Text>)/;/g/;
            </TouchableOpacity>)/;/g/;
          )}
          ...
          {actions.map(action, index) => (<TouchableOpacity;}  />/;,)key={index}/g/;
            ...
            >);
              <Text style={styles.buttonText}>{action.title}</Text>)/;/g/;
            </TouchableOpacity>)/;/g/;
          ))}
        </View>/;/g/;
      </View>/;/g/;
