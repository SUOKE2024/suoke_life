...
import DataDisplay from "../DataDisplay";""/;"/g"/;
...
';,'';
describe("DataDisplay", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <DataDisplay  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('datadisplay')).toBeTruthy();'';'';
}
  });
';,'';
