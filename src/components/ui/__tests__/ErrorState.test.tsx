...
import ErrorState from "../ErrorState";""/;"/g"/;
...
';,'';
describe("ErrorState", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <ErrorState  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('errorstate')).toBeTruthy();'';'';
}
  });
';,'';
