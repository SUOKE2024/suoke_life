...
import ColorPicker from "../ColorPicker";""/;"/g"/;
...
';,'';
describe("ColorPicker", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <ColorPicker  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('colorpicker')).toBeTruthy();'';'';
}
  });
';,'';
