...
import FileUpload from "../FileUpload";""/;"/g"/;
...
';,'';
describe("FileUpload", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <FileUpload  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('fileupload')).toBeTruthy();'';'';
}
  });
';,'';
