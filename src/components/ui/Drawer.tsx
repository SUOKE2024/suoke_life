...
// 抽屉项组件/;,/g/;
export interface DrawerItemProps {;,}const title = string;
...
accessibilityLabel={accessibilityLabel || title}
    ...
    >;
      ...
      <Text style={styles.text}>{title}</Text>)/;/g/;
    </TouchableOpacity>)/;/g/;
  );
};

// 抽屉分组组件/;,/g/;
export interface DrawerSectionProps {;,}title?: string;
const children = React.ReactNode;
style?: ViewStyle;
}
}
...
return (<View style={[styles.section, style]}>;)      {title && <Text style={styles.title}>{title}</Text>})/;/g/;
      {children});
    </View>)/;/g/;
  );
};
