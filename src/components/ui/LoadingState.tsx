...
color?: string;
  /** 骨架屏配置 *//;,/g/;
skeletonConfig?: {lines?: number;,}showAvatar?: boolean;
}
}
    showImage?: boolean;}
  };
...
case 'lg': ';,'';
return currentTheme.typography.fontSize.lg;
default: ;
}
...
const  renderSkeleton = useCallback(() => {}
    return (<View style={styles.skeletonContainer}>;)        {skeletonConfig.showAvatar && (}';)          <View style={styles.skeletonRow}>';'';
            ...
            <View style={styles.skeletonContent}>";"";
              ...
              <Skeleton variant="text" width="40%" height={12}  />")""/;"/g"/;
            </View>)/;/g/;
          </View>)/;/g/;
        )}
";"";
...
style={styles.skeletonImage});
        ...
        {Array.from({ length: skeletonConfig.lines || 3 ;}).map(_, index) => (<Skeleton;)"  />/;,"/g"/;
key={index})";,"";
variant="text")";,"";
...
if (type === 'skeleton') {';}}'';
    return ()}
      <View style={[styles.container, style]}>{renderLoadingIndicator()}</View>/;/g/;
    );
  }
