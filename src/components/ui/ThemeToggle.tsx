//;/g/;
//;/g/;
// 索克生活 - 主题切换组件   支持在浅色和暗黑模式之间切换/;,/g/;
import React,{ useRef } from ";react";";
View,;
Text,";,"";
StyleSheet,";"";
  { Animated } from "react-native";";
interface ThemeToggleProps {";,}size?: ";small" | medium" | "large;";,"";
showLabel?: boolean;
}
}
style?: unknown;}";"";
...
return (;)";"";
    <View style={[styles.container, style]}  />/          {showLabel && (;)"}""/;"/g"/;
        <Text style={[styles.label, { color: theme.colors.onSurfa;c;e   }}]}  />/          {isDark ? "暗黑模式 : "浅色模式"}""/;"/g"/;
        </Text>/          )}/;/g/;
      <TouchableOpacity,  />/;,/g/;
...
accessibilityState={ checked: isDark;}} />/            <Animated.View;  />/;,/g/;
...
style={[;,]styles.thumb,;}            {width: sizeStyles.thumbSize}height: sizeStyles.thumbSize,;
              ...
              borderRadius: sizeStyles.thumbSize / 2,/                  backgroundColor: theme.colors.surface,}/;/g/;
];
transform: [{ translateX: thumbTranslateX   ;}}],;
              ...theme.shadows.sm;";"";
            }";"";
          ]} />/          <View style={[styles.thumbIcon, { backgroundColor: isDark ? "#FFD700" : #87CEEB";}}]}  />/        </Animated.View>/      </TouchableOpacity>/    </View>/      );""/;"/g"/;
}";,"";
