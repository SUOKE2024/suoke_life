...
interface AgentEmotionFeedbackProps {onFeedback: (feedbackKey: string) => void;,}disabled?: boolean;
}
}
...
return (<View style={styles.container}>);
      <Text style={styles.title}>您的反馈</Text>)/;/g/;
      <View style={styles.row}>);
        {FEEDBACKS.map((fb) => (<TouchableOpacity,)}  />/;,/g/;
key={fb.key});
