...
agentType?: AgentTypecurrentChannel?: string;
const userId = string;
...
style: "cancel" ;},{"onPress: () => {setMessages([]);}}"";
  ...
  /* " *//;"/g"/;
  */"
const renderMessage = useCallback(message: Message) => {const isUser = message.type === "userconst agentRole = message.agentType;"";
