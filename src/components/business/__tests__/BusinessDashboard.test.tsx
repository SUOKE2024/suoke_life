...
import BusinessDashboard from "../BusinessDashboard";""/;"/g"/;
...
';,'';
describe("BusinessDashboard", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <BusinessDashboard  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('businessdashboard')).toBeTruthy();'';'';
}
  });
';,'';
