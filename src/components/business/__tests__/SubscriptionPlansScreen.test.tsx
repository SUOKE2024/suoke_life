...
import SubscriptionPlansScreen from "../SubscriptionPlansScreen";""/;"/g"/;
...
';,'';
describe("SubscriptionPlansScreen", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <SubscriptionPlansScreen  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('subscriptionplansscreen')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <SubscriptionPlansScreen {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
