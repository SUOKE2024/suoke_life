...
import BusinessQuickAccess from "../BusinessQuickAccess";""/;"/g"/;
...
';,'';
describe("BusinessQuickAccess", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <BusinessQuickAccess  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('businessquickaccess')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <BusinessQuickAccess {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
