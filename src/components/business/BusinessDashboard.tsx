...
const  loadBusinessMetrics = async () => {try {}      // 模拟数据加载
...
const color = string;);
trend?: number);
  ) => (<View style={styles.metricCard}>;)      <LinearGradient,  />
...
const  renderRevenueBreakdown = () => (<View style={styles.section}>;)      <Text style={styles.sectionTitle}>收入构成</Text>
...
const  renderQuickActions = () => (<View style={styles.section}>;)      <Text style={styles.sectionTitle}>快速操作</Text>
...
const  renderTopPerformers = () => (<View style={styles.section}>;)      <Text style={styles.sectionTitle}>业绩排行</Text>
