...
import ListenDiagnosisComponent from "../ListenDiagnosisComponent";""/;"/g"/;
...
';,'';
describe("ListenDiagnosisComponent", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <ListenDiagnosisComponent  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('listendiagnosiscomponent')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <ListenDiagnosisComponent {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
