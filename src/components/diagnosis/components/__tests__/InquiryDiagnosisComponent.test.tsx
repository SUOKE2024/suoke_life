...
import InquiryDiagnosisComponent from "../InquiryDiagnosisComponent";""/;"/g"/;
...
';,'';
describe("InquiryDiagnosisComponent", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <InquiryDiagnosisComponent  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('inquirydiagnosiscomponent')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <InquiryDiagnosisComponent {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
