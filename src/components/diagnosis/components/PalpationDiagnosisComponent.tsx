...
const  renderPulseSection = () => (<View style={styles.testSection}>;)      <Text style={styles.sectionTitle}>脉诊检测</Text>
...
recordingType === 'pulse' &&
  ...
  const  renderPressureSection = () => (<View style={styles.testSection}>;)      <Text style={styles.sectionTitle}>按诊检测</Text>
      <Text style={styles.sectionDescription}>;
      </Text>
...
const  renderAnalysisResult = () => {if (!analysisResult) return null}
    ...
    return (<View style={styles.resultContainer}>;)        <Text style={styles.resultTitle}>分析结果</Text>
        ...
        {analysisResult.pressureAnalysis && (<View style={styles.analysisSection}>;)            <Text style={styles.analysisTitle}>按诊分析</Text>
...
return (<ScrollView style={styles.container} showsVerticalScrollIndicator={false}>;)      <Text style={styles.title}>切诊分析</Text>
