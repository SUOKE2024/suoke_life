...
import { DiagnosisComponentProps, LookDiagnosisData } from '../../../types/diagnosis';
      ...
      <View style={styles.resultContainer}>
        ...
        {analysisResult.faceAnalysis && (
          <View style={styles.analysisSection}>
            ...
            <Text style={styles.analysisText}>面色：{analysisResult.faceAnalysis.complexion}</Text>
            <Text style={styles.analysisText}>精神：{analysisResult.faceAnalysis.spirit}</Text>
            <Text style={styles.confidenceText}>
              置信度：{(analysisResult.faceAnalysis.confidence * 100).toFixed(1)}%
            </Text>
          </View>
        )}
        ...
        {analysisResult.tongueAnalysis && (
          <View style={styles.analysisSection}>
            ...
            <Text style={styles.analysisText}>舌质：{analysisResult.tongueAnalysis.tongueBody}</Text>
            <Text style={styles.analysisText}>舌苔：{analysisResult.tongueAnalysis.tongueCoating}</Text>
            <Text style={styles.confidenceText}>
              置信度：{(analysisResult.tongueAnalysis.confidence * 100).toFixed(1)}%
            </Text>
          </View>
        )}
