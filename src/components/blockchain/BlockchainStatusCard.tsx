...
const getStatusColor = useCallback(() => {if (!isConnected) return '#FF6B6Bif (status?.consensusStatus === 'SYNCED') return '#4ECDC4
...
const getColor = useCallback(() => {if (!isConnected) return '#FF6B6Bif (status?.consensusStatus === 'SYNCED') return '#4ECDC4
if (status?.consensusStatus === 'SYNCING') return '#FFE66D';
}
    return '#FF6B6B}
  };
