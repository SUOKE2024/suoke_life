...
const hasError = booleanerror?: Error;
}
  errorInfo?: any}
}
...
;}) => {';}}
  if (type === 'spinner') {'}
return (<View style={styles.loadingContainer}>';)        <ActivityIndicator size="large" color="#007AFF"  />")
...
// 预加载管理器
class PreloadManager {private static instance: PreloadManagerprivate preloadedComponents = new Map<string, Promise<any>>();
...
if (preload) {}
  ...
  // 创建带重试机制的导入函数
const importWithRetry = async (attempt = 1): Promise<{ default: T ;}> => {try {}      // 检查是否有预加载的组件
