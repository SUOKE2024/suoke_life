...
borderRadius?: number;
  ...
  style?: any}
}> = ({  width, height, borderRadius = 4, style  }) => {const animatedValue = React.useRef(new Animated.Value(0)).currentReact.useEffect() => {const  animation = Animated.loop()Animated.sequence([;))]Animated.timing(animatedValue, {)toValue: 1,);
}
          duration: 1000;),}
