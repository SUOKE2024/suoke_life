...
import EnhancedLazyComponents from "../EnhancedLazyComponents";""/;"/g"/;
...
';,'';
describe("EnhancedLazyComponents", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <EnhancedLazyComponents  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('enhancedlazycomponents')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <EnhancedLazyComponents {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
