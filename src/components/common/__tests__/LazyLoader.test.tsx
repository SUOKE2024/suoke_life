...
import LazyLoader from "../LazyLoader";""/;"/g"/;
...
';,'';
describe("LazyLoader", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <LazyLoader  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('lazyloader')).toBeTruthy();'';'';
}
  });
';,'';
