...
import LazyComponents from "../LazyComponents";""/;"/g"/;
...
';,'';
describe("LazyComponents", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <LazyComponents  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('lazycomponents')).toBeTruthy();'';'';
}
  });
';,'';
