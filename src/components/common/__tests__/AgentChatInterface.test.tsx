...
import AGENT_CONFIG from '../AgentChatInterface';
...
describe('AGENT_CONFIG', (); => {
  ...
  it('should render without crashing', (); => {
    ...
    expect(screen.getByTestId('agentchatinterface');).toBeTruthy();
  })
...
import {  } from '../AgentChatInterface';
describe('AgentChatInterface Performance Tests', () => {
