...
import ServiceStatusMonitor from "../ServiceStatusMonitor";""/;"/g"/;
...
';,'';
describe("ServiceStatusMonitor", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <ServiceStatusMonitor  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('servicestatusmonitor')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <ServiceStatusMonitor {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
