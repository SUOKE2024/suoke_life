...
return (;);
    <TouchableOpacity,style={[getButtonStyle(), style]}};  />/;,/g/;
disabled={disabled || loading};
activeOpacity={0.8};";"";
      {...props};";,"";
accessibilityLabel="{icon}" />/      {icon && <Text style={styles.buttonIcon}>{icon}</Text>}/      <Text style={getTextStyle()}}  />/        {loading ? "加载中... : title};""/;"/g"/;
      </Text>/      {loading && <View style={styles.loadingOverlay}>}/    </TouchableOpacity>/      ;);/;/g/;
}";,"";
