...
style={styles.actionButton}
  ...
  // 空状态渲染 // / TODO: 将内联组件移到组件外部* * const renderEmptyState = useMemo(() => useMemo((); => useMemo(() => () => ( * / <View style={styles.emptyState} />/      <Icon name="account-search" size={64} color={colors.textSecondary} />/      <Text style={styles.emptyTitle} />/        {searchQuery ? 未找到匹配的联系人" : "暂无联系人}////
