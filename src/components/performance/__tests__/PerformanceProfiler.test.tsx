...
import PerformanceProfiler from "../PerformanceProfiler";""/;"/g"/;
...
';,'';
describe("PerformanceProfiler", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <PerformanceProfiler  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('performanceprofiler')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <PerformanceProfiler {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
