...
import ExpertVerificationSystem from "../ExpertVerificationSystem";""/;"/g"/;
...
';,'';
describe("ExpertVerificationSystem", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <ExpertVerificationSystem  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('expertverificationsystem')).toBeTruthy();'';'';
}
  });
';,'';
...
render(;)      <TestWrapper>;
        <ExpertVerificationSystem {...testProps}  />/;/g/;
      </TestWrapper>/;/g/;
    );
