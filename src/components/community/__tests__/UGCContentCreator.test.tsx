...
import UGCContentCreator from "../UGCContentCreator";""/;"/g"/;
...
';,'';
describe("UGCContentCreator", () => {';,}it('应该正确渲染', () => {'';,}render(;)      <TestWrapper>;'';
        <UGCContentCreator  />/;/g/;
      </TestWrapper>/;/g/;
    );

    // 基础渲染测试'/;,'/g'/;
expect(screen.getByTestId('ugccontentcreator')).toBeTruthy();'';'';
}
  });
';,'';
