...
// 国际化Hookexport const useI18n = (): UseI18nReturn =;> ;{;
  ...
  // 翻译函数 *   const t = useCallback((key: string, options?: { [key: string]: unkno;w;n ;}); => { */
  ...
  const formatDate = useCallback((date: Date | string | number, format?: strin;g;); => {
  ...
  // 设置函数 *   const setLanguage = useCallback(async (newLanguage: SupportedLanguag;e;); => { */
    try {
