...
export const usePerformanceMonitor = ;(;
  ...
  const { componentName, enableMemoryMonitoring = false, threshold = 16   } = optio;n;s;
  const renderStartTime = useRef<number>(0);
  const [metrics, setMetrics] = useState<PerformanceMetrics | null>(nul;l;);
  useEffect((); => {
