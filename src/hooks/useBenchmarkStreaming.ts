...
import { benchmarkStreamingService } from "../services";""/;,"/g"/;
import type { StreamEvent, StreamConfig } from "../services";""/;,"/g"/;
...
interface UseBenchmarkStreamingOptions {autoConnect?: boolean;,}maxEvents?: number;
}
}
  eventTypes?: string[];}";"";
}';,'';
