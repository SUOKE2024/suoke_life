;/import { LocalizationService } from ./localizationService"/importzhCN from "./locales/zh.json/importenUS from ";./locales/    en.json;""/;"/g"/;
";"";
...
export class I18nManager extends EventEmitter   {private currentLanguage: SupportedLanguage = DEFAULT_LANGUAGE;,}private currentRegion: string = CN;
...
if (this.isInitialized) {return;}
    try {const systemLanguage = await this.detectSystemLanguag;e;,}const [savedLanguage, savedRegion, savedPreferences] = await Promise.all([;););]];
...
return (matchedLanguage as SupportedLanguage) || DEFAULT_LANGUA;G;E;
  ...
  const: mapping: Record<string, string> = {";,}zh": "zh-CN,";"";
