...
// 异步thunk actions * export const fetchHealthSummary = createAsyncThun;k;<; */
  HealthSummary,
  void,
  { rejectValue: string}
...
export const fetchHealthTrends = createAsyncThun;k;<;
  HealthData[],
...
export const syncHealthData = createAsyncThun;k;<
  HealthData[],
  void,
  { rejectValue: string}
...
export const analyzeHealthData = createAsyncThun;k;<;
  HealthSummary,
  { dataIds: string[]   },
  { rejectValue: string}
...
export const generateHealthReport = createAsyncThun;k;<
  ...
  extraReducers: (builder) => {
    ...
    // 同步健康数据 *     builder */
      ...
      .addCase(syncHealthData.fulfilled, (state, action); => {
        state.loading = false;
        // 合并新数据，避免重复 *         const existingIds = new Set(state.data.map((ite;m;); => item.id)); */
...
// 选择器 * export const selectHealth = (state: { health: HealthState }) => state.heal;t;h; */;
