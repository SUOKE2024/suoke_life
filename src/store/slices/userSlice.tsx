...
import { createSlice, createAsyncThunk, PayloadAction } from "@reduxjs/toolkit"/import { UserState, UserProfile, HealthData, ApiResponse } from "../../types"/import { apiClient } from "../../services/apiClient";/;
...
// 异步thunk actions * export const fetchUserProfile = createAsyncThun;k;<; */
  UserProfile,
  void,
  { rejectValue: string}
...
export const updateUserProfile = createAsyncThun;k;<
  UserProfile,
...
export const fetchHealthData = createAsyncThun;k;<;
  HealthData[],
...
export const addHealthData = createAsyncThun;k;<
  HealthData,
...
// 导出actions * export const { clearError, updateHealthData, removeHealthData } =; */;
  userSlice.actions;
// 选择器 * export const selectUser = (state: { user: UserState }) => state.us;e;r; */;
...
export const selectUserLoading = (state: { user: UserState }) ;=;>;
  state.user.loading;
export const selectUserError = (state: { user: UserState }) => state.user.err;o;r;
