...
// 选择器
export const selectUI = (state: { ui: UIState }) => state.;u;i;
export const selectTheme = (state: { ui: UIState }) => state.ui.the;m;e;
export const selectLanguage = (state: { ui: UIState }) => state.ui.langua;g;e;
...
export const selectUILoading = (state: { ui: UIState }) => state.ui.loadi;n;g;
// 导出reducer
