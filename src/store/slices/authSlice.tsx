...
// 异步thunk actions
export const login = createAsyncThun;k;<
...
export const register = createAsyncThun;k;<
  { user: User, token: string, refreshToken: string },
  RegisterRequest,
  { rejectValue: string }
...
export const refreshToken = createAsyncThun;k;<
...
export const checkAuthStatus = createAsyncThun;k;<
  User,
  void,
  { rejectValue: string }
...
export const forgotPassword = createAsyncThun;k;<
  void,
  string,
  { rejectValue: string }
...
export const verifyResetCode = createAsyncThun;k;<
  void,
...
export const resetPassword = createAsyncThun;k;<
  void,
...
export const { clearError, setLoading   } = authSlice.actio;n;s;
// Selectors
export const selectIsAuthenticated = (state: { auth: AuthState }) ;=;>;
  state.auth.isAuthenticated;
export const selectUser = (state: { auth: AuthState }) => state.auth.us;e;r;
export const selectAuthLoading = (state: { auth: AuthState }) => state.auth.loadi;n;g;
export const selectAuthError = (state: { auth: AuthState }) => state.auth.err;o;r;
export const selectAuthToken = (state: { auth: AuthState }) => state.auth.tok;e;n;
