...
// showErrorNotification,
  ...
  // 检查是否是异步action // if (action.type && typeof action.type === "string") {const { type   } = acti;
o;n;
    ...
    // 处理rejected状态 // if (type.endsWith(" / rejected")) { * ////
      // 显示错误通知 // const errorMessage = action.payload || "操作失败，请稍后重试;";
