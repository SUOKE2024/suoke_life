...
export const AGENT_CAPABILITIES = {
  ...
  [AgentType.LAOKE]: [
    ...
    "blog_management",
    "knowledge_graph",
    "rag_system","ar_vr_interaction","content_moderation";
  ],[AgentType.SOER]: [;
...
export const AGENT_ROLES = {
  ...
  },[AgentType.LAOKE]: {name: "老克",title: "探索频道版主",description: "负责知识传播、培训和博物馆导览，兼任玉米迷宫NPC",primaryChannel: "explore",specialties: ["知识管理", "教育培训", "内容策展", "游戏引导"];
  },[AgentType.SOER]: {name: "索儿",title: "LIFE频道版主",description: "提供生活健康管理、陪伴服务和数据整合分析",primaryChannel: "life",specialties: ["生活方式管理", "情感支持", "数据整合", "健康陪伴"];
  };
} as const;
 ...
 * 任务类型常量
 */
export const TASK_TYPES = {DIAGNOSIS: "diagnosis",RECOMMENDATION: "recommendation",EDUCATION: "education",LIFESTYLE: "lifestyle",EMERGENCY: "emergency",COORDINATION: "coordination";
} as const;

/**
 * 任务优先级常量
 */
export const TASK_PRIORITIES = {LOW: "low",MEDIUM: "medium",HIGH: "high",CRITICAL: "critical";
} as const;

/**
 * 智能体状态常量
 */
export const AGENT_STATUSES = {INITIALIZING: "initializing",ACTIVE: "active",INACTIVE: "inactive",ERROR: "error",MAINTENANCE: "maintenance";
} as const;

/**
 * 健康状态常量
 */
export const HEALTH_STATUSES = {HEALTHY: "healthy",DEGRADED: "degraded",UNHEALTHY: "unhealthy",OFFLINE: "offline";
} as const;
 ...
 * 智能体系统配置
 */
export const AGENT_SYSTEM_CONFIG = {version: "1.0.0",maxConcurrentTasks: 10,healthCheckInterval: 30000,autoRestart: true,logLevel: "info" as const,performanceMonitoring: true,resourceLimits: {memory: 512, // MB;
    cpu: 80, // 百分比;
  };
} as const;
