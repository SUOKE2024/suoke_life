...
/* 数 */
 */
export const AgentSystemUtils = {/* 型 *//;}   */
...
hasCapability(agentType: AgentType, capability: string): boolean {}
  ...
  /* 略 */
   */
getCollaborationStrategy(taskType: string) {const return = COLLABORATION_STRATEGIES[]const taskType: keyof typeof COLLABORATION_STRATEGIES}
];
    ]}
  }
  /* 文 */
