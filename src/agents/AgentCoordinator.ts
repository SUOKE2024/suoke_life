  ...
  */
  private async analyzeTask()
    ...
    if ()
      ...
      primaryAgent: AgentType.XIAOAI,supportingAgents: [AgentType.XIAOKE, AgentType.LAOKE, AgentType.SOER],collaborationMode: "sequential",priority: "high";
      };
    }
    // 生活方式优化 - 需要索儿主导，其他支持
    if ()
      ...
      primaryAgent: AgentType.SOER,supportingAgents: [AgentType.XIAOAI, AgentType.LAOKE],collaborationMode: "sequential",priority: "medium";
      };
    }
    // 知识学习类 - 老克主导
    if ()
      ...
      primaryAgent: AgentType.LAOKE,supportingAgents: [AgentType.XIAOAI],collaborationMode: "single",priority: "medium";
      };
    }
    // 服务推荐类 - 小克主导
    if ()
      ...
      primaryAgent: AgentType.XIAOKE,supportingAgents: [AgentType.XIAOAI, AgentType.SOER],collaborationMode: "sequential",priority: "medium";
      };
    }
    // 紧急情况 - 需要所有智能体协作
    if ()
      ...
      return {
      type: "emergency",
      primaryAgent: AgentType.XIAOAI,supportingAgents: [AgentType.XIAOKE, AgentType.LAOKE, AgentType.SOER],collaborationMode: "parallel",priority: "critical";
      };
    }
    // 默认单智能体处理
    return {
      type: "general",
      primaryAgent: this.selectPrimaryAgent(context),supportingAgents: [],collaborationMode: "single",priority: "low";
    };
  }
  /**
  * 处理单智能体任务
  ...
  */
  private async handleConsensusCollaboration()
    ...
    return {success: true,response: consensusResult.decision,data: {consensusConfidence: consensusResult.confidence,participatingAgents: allAgents,individualDecisions: decisions,reasoning: consensusResult.reasoning;
      ...
      agentCount: allAgents.length,timestamp: new Date().toISOString();
      };
    };
  }
  /**
  ...
  */
  ...
  primaryResult: primaryResult.data,
        ...
        taskType: taskAnalysis.type,collaborationMode: taskAnalysis.collaborationMode;
          ...
          taskAnalysis.primaryAgent,...taskAnalysis.supportingAgents;
        ],totalExecutionTime: results.reduce((acc, item) => acc + item, 0);
