import { AgentApiService } from "../../services/api/agentApiService";""/;,"/g"/;
import { AgentFactory } from "../factory/AgentFactory";""/;,"/g"/;
import { MessageType } from "../types/agents";""/;"/g"/;

/* 法 *//;/g/;
 *//;,/g/;
export class AgentUsageExample {/* 参 *//;}   *//;,/g/;
const public = static async xiaoaiHealthConsultationExample(): Promise<void> {try {}      // 1. 创建小艾智能体;/;,/g/;
...
const data = {);}}
  ...
  /* 制 *//;/g/;
   *//;,/g/;
const public = static async xiaokeServiceManagementExample(): Promise<void> {try {}      // 1. 创建小克智能体/;,/g/;
const agentFactory = AgentFactory.getInstance();
...
const deliverySchedule = 'weekly';')'';'';
  ...
  /* 动 *//;/g/;
   *//;,/g/;
const public = static async laokeKnowledgeExample(): Promise<void> {try {}      // 1. 创建老克智能体/;,/g/;
const agentFactory = AgentFactory.getInstance();
...
const  knowledgeResponse = await apiService.laokeKnowledgeRetrieval({';,)userId: 'user123';',')';})';'';
  ...
  /* 理 *//;/g/;
   *//;,/g/;
const public = static async soerLifestyleManagementExample(): Promise<void> {try {}      // 1. 创建索儿智能体/;,/g/;
const agentFactory = AgentFactory.getInstance();
