import {Constitution}HealthRecommendation,;
medKnowledgeService,;
}
  Symptom,};
...
const confidence = matchingSymptoms.length / symptoms.length;/;,/g/;
...
return {constitutions: topMatches.map((match) => match.constitution)}const confidence = overallConfidence;
  ...
  /* 议 *//;/g/;
   *//;,/g,/;
  async: getPersonalizedAdvice(constitutionId: string,;,)const userContext = {age?: number;,}gender?: string;
