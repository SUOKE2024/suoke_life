...
export interface HealthProfile { chronicConditions: string[],
  allergies: string[],
...
export interface HealthRecommendation { category: | "diet"| "exercise"| "lifestyle",
    | "medical"
    | "tcm"
    | "mental_health"
  title: string,
...
export interface ConstitutionResult { primaryConstitution: ConstitutionType,
...
// 中医相关类型 * export interface TCMFindings {////  ;
 /////    ;
  ...
  prognosis?: string}
export interface TCMDiagnosis { mainSyndrome: string,
...
export interface TreatmentPlan  {
  [key: string]: unknown}
export interface SharedContext  {[key: string]: unknown};
