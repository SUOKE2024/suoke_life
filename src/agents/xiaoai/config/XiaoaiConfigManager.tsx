...
';,'';
import { APP_CONFIG, CACHE_CONFIG } from "../../../constants/config";""/;,"/g"/;
import { usePerformanceMonitor } from "../../../hooks/usePerformanceMonitor";""/;,"/g"/;
import {AccessibilityConfig}DiagnosisConfig,;
...
conversationHistory: 90, // 天/;/g/;
}
      diagnosticImages: 365, // 天}/;/g/;
    ;}
...
getPerformanceMetrics(): {cacheHitRate: number}configSize: number,;
  ...
  } {const cacheSize = this.configCache.size;,}const totalKeys = Object.keys(this.config).length;
