...
startSession(userId: string): Promise<string>askQuestion(sessionId: string, question: string): Promise<InquiryResult>;
}
...
return data;
    } catch (error) {lastError = error as ErrorclearTimeout(timeoutId);
...
constructor() {this.baseUrl = API_CONFIG.inquiry.baseUrlthis.timeout = API_CONFIG.inquiry.timeout;
}
...
private timeout: number;
private retries: number;
constructor() {this.baseUrl = API_CONFIG.look.baseUrlthis.timeout = API_CONFIG.look.timeout;
}
...
private timeout: number;
private retries: number;
constructor() {this.baseUrl = API_CONFIG.listen.baseUrlthis.timeout = API_CONFIG.listen.timeout;
}
...
private timeout: number;
private retries: number;
constructor() {this.baseUrl = API_CONFIG.palpation.baseUrlthis.timeout = API_CONFIG.palpation.timeout;
}
