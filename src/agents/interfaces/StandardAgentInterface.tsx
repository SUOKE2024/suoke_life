...
// 索克生活标准化智能体接口   统一智能体输入输出格式和协作协议
export interface AgentRequest {;
  // 请求ID，用于追踪  requestId: string;
  // 用户ID  userId: string;
  // 消息内容  message: string
  // 消息类型  messageType: "text" | "voice" | "image" | "data";
...
// 智能体响应验证器export class AgentResponseValidator  {;
  // /    验证响应格式  static validateResponse(response: unknown);:   {, valid: boolean,
    errors: string[];
    } {
    const errors: string[] = []
...
// 智能体工厂接口export interface IAgentFactory {;
  // /    创建智能体实例  createAgent(agentId: string, config?: unknown);: Promise<IStandardAgent />;
