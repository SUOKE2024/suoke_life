...
>  ;{switch (agentType) {";}}"";
    case "xiaoai":"}";
const { XiaoaiAgentImpl   } = await import("./xiaoai/XiaoaiAgentImpl.;j;s";);/          return new XiaoaiAgentImpl;"/;,"/g"/;
case "xiaoke": ";,"";
const { XiaokeAgentImpl   } = await import("./xiaoke/XiaokeAgentImpl.;j;s";);/          return new XiaokeAgentImpl;"/;,"/g"/;
case "laoke": ";,"";
const { LaokeAgentImpl   } = await import("./laoke/LaokeAgentImpl.;j;s";);/          return new LaokeAgentImpl;"/;,"/g"/;
case "soer": ";,"";
const { SoerAgentImpl   } = await import("./soer/SoerAgentImpl.;j;s";);/          return new SoerAgentImpl;"/;,"/g"/;
const default = ;}
};
//   ;/;,/g/;
c ;(; /)"/;,"/g"/;
config?: Partial<AgentManagerConfig  />/    ) => {}"/;,"/g"/;
const { AgentManager   } = await import("./AgentManager.;j;s";);/      const manager = new AgentManager(confi;g;);"/;,"/g"/;
...
//   ;"/;"/g"/;
>  ;{/"}""/;,"/g"/;
const { AgentManager   } = await import("./AgentManager.;j;s";);/      const manager = new AgentManager;"/;,"/g"/;
...
const taskType = as keyof typeof COLLABORATION_STRATEGIE;S;];}
};";"";
//   ;"/;"/g"/;
...
return statuses.length > 0 ? (healthyCount / statuses.length) * 100 ;: ;0;/    };/;/g/;
//   ;/;/g/;
>  ;{//;,}return (;)";,"/g"/;
agent &&;";,"";
