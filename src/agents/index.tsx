...
importtype{ XiaoaiAgent } from "./xiaoai/types"/
  AgentType,
  AgentTask,
...
// 智能体类型定义 * export type { XiaoaiAgent, */
  ...
  ChatContext,
  VoiceResponse,
  { FourDiagnosisResults } from "./xiaoai/types"//  *  智能体协调器 *// export { AgentCoordinator,
  agentCoordinator,
  type AgentType,
  type AgentTask,
  ...
  type SharedContext,
  { type AgentInstance } from "./AgentCoordinator.js"//  *  智能体管理器 *// export { AgentManager,
  type AgentManagerConfig,
  type AgentStatus,
  { type AgentMetrics } from "./AgentManager.js"//  *  智能体实现 *// export { XiaoaiAgentImpl } from ". * xiaoai *//XiaoaiAgentImpl.js"/export { XiaokeAgentImpl } from "./xiaoke/XiaokeAgentImpl.js"/export { LaokeAgentImpl } from "./laoke/LaokeAgentImpl.js"/export { SoerAgentImpl } from "./soer/SoerAgentImpl.js";/;
...
// 初始化智能体系统 * export const initializeAgentSystem = asyn;c ;(; */;
...
// 协作模式常量 * export const COLLABORATION_MODES = ;{; */
  SEQUENTIAL: "sequential", // 顺序协作 *   PARALLEL: "parallel",  *// 并行协作* *   HIERARCHICAL: "hierarchical",  * */// 层次协作* *   CONSENSUS: "consensus",  * */// 共识协作* * } as const; * *//
// 任务类型常量 * export const TASK_TYPES = ;{; */
  DIAGNOSIS: "diagnosis",
...
// 智能体能力检查函数 * export const hasCapability = (agentType: AgentTyp;e, */;
...
// 根据频道获取智能体 * export const getAgentByChannel = (channel: keyof typeof AGENT_CHANNE;L;S;): AgentType =>  {; */;
