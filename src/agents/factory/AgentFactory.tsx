...
export class AgentFactory {private static instance: AgentFactoryprivate agents: Map<AgentType, AgentInstance  /> = new Map();/      private config: AgentFactoryConfig;
}
}
...
if (instance) {instance.status = status}
  ...
  // 注册智能体实例  private async registerAgent(agent: Agent, config: AgentConfig): Promise<void>  {/const instance: AgentInstance = {id: agent.idagent,,/g/;
config,","
status: AgentStatus.IDLE,","
