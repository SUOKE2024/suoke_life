...
export const XIAOAI_CONFIG: AgentConfig = {
  ...
  description: '索克生活APP首页（聊天频道）版主，为用户提供语音引导、交互、问诊，以及包括导盲、导医、手语识别等无障碍服务，统筹协调望诊、闻诊、问诊、切诊、算诊服务。',
  channel: '首页聊天频道',
  role: '四诊协调智能体',
  capabilities: [
...
export const XIAOKE_CONFIG: AgentConfig = {
  ...
  description: '索克生活APP SUOKE频道版主，负责索克生活服务订阅、优质农产品预（定）制、供应链管理、农事活动体验、第三方API服务集成、索克店铺管理等工作。',
  channel: 'SUOKE频道',
  role: '服务管理智能体',
  capabilities: [
...
export const LAOKE_CONFIG: AgentConfig = {
  ...
  description: '索克生活APP探索频道版主，负责知识传播、知识培训和用户博客管理等工作，兼任索克游戏NPC。',
  channel: '探索频道',
  role: '知识传播智能体',
  capabilities: [
...
export const SOER_CONFIG: AgentConfig = {
  ...
  name: '索儿',
  type: AgentType.SOER,
  description: '索克生活APP LIFE频道版主，为用户提供生活（健康）管理、陪伴等服务，整合用户饮食起居、实时感知（通过手机、智能手表、运动装备、医疗装备等）等工作。',
  channel: 'LIFE频道',
  role: '生活健康管理智能体',
  capabilities: [
