...
// 索克生活四智能体系统配置/;/g/;
// 基于README.md第1013-1063行的智能体描述/;,/g/;
...
technicalFeatures: {multimodalLLM: true, // 多模态大语言模型 (GPT-4o / Gemini 1.5 Pro)/;,/g,/;
  ...
  fourDiagnosisIntegration: true, // 四诊合参模块集成/;/g/;
}
...
technicalFeatures: {dataFusion: true, // 多源异构数据融合/;,/g,/;
  ...
  emotionalComputing: true, // 情感计算/;/g/;
}
