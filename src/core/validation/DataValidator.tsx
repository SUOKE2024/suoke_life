...
export class DataValidator {private static instance: DataValidatorprivate rules: Map<string, ValidationRule> = new Map();
...
private constructor() {}
  ...
  type: ValidationType,
context: ValidationContext = {}
  ): ValidationReport  {const reportId = this.generateReportIdconst timestamp = Date.now;
...
const report: ValidationReport = {id: reportIdtimestamp,
