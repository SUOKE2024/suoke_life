...
// 默认配置
export const DEFAULT_CONFIGS = {EDGE_COMPUTE: {enableBatching: true,batchSize: 1,maxConcurrentSessions: 3,memoryLimit: 2 * 1024 * 1024 * 1024, // 2GB;
cpuThreads: 4,
    enableGPU: true,
    enableNPU: false,
...
export const PROVIDER_PRIORITY: Record<string, ExecutionProvider[]> = {
  ...
  web: ["webgpu, "webgl", cpu"],default: ["cpu]";
};
// 量化级别配置
export const QUANTIZATION_CONFIGS = {int8: {level: "int8" as QuantizationLevel,compressionRatio: 4,accuracyLoss: 0.02,speedGain: 2.5,memoryReduction: 0.75;
  },
  int16: {
...
export const OPTIMIZATION_LEVELS = {basic: {level: basic" as OptimizationLevel,";
    enableConstantFolding: true,enableRedundantNodeElimination: true,enableCommonSubexpressionElimination: false,enableLoopOptimization: false;
  },
  extended: {
...
// 设备能力阈值
export const DEVICE_THRESHOLDS = {MEMORY: {LOW: 1 * 1024 * 1024 * 1024,    // 1GB;
...
// 性能基准
export const PERFORMANCE_BENCHMARKS = {INFERENCE_TIME: {EXCELLENT: 50,   // ms;
GOOD: 100,
    ACCEPTABLE: 200,
    POOR: 500;
  },
...
// 缓存键前缀
export const CACHE_KEYS = {MODEL: "onnx_model_,",INFERENCE: "onnx_inference_",DEVICE_CAPS: device_capabilities_",";
  PERFORMANCE: "performance_metrics_;"
} as const;
// 事件名称
export const EVENT_NAMES = {MODEL_LOADED: "model_loaded",MODEL_UNLOADED: model_unloaded",";
  INFERENCE_STARTED: "inference_started,",INFERENCE_COMPLETED: "inference_completed",INFERENCE_FAILED: inference_failed",";
  CACHE_HIT: "cache_hit,",CACHE_MISS: "cache_miss",OPTIMIZATION_COMPLETED: optimization_completed",";
  QUANTIZATION_COMPLETED: "quantization_completed,";
  DEVICE_CAPABILITY_DETECTED: "device_capability_detected';"'
} as const;
// 默认超时时间
export const TIMEOUTS =  {MODEL_LOAD: 30000,      // 30秒
INFERENCE: 10000,       // 10秒
