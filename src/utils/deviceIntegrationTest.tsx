...
interface ApiResponse<T = any  /> {/data: T;/     , success: boolean;
  ...
  message?: string;}","
code?: number}","
const importdeviceInfoManager = from "./deviceInfo";//import nativeModulesManager from "./nativeModules"
/
...
try {const deviceInfo = await deviceInfoManager.getDeviceSpec;stestSuites.push(await this.runDeviceCompatibilityTests);
...
try {";}}
          const startTime = Date.now(;);"}
response: await fetch("https:///     method: "GET",timeout: 100;);""
