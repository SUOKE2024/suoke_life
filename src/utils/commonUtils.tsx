// 通用工具函数
// 防抖函数export const debounce = <T extends (...args: unknown[]) = /> any>(/ , func: ;T,
...
// 节流函数export const throttle = <T extends (...args: unknown[]) = /> any>(/ , func: ;T,
...
// 获取设备信息export const getDeviceInfo = () =;> ;{;
  // 简化版本，实际项目中应该使用react-native-device-info *   return { */
    platform: "ios", // 或 'android' *     version: "1.0.0", */
    buildNumber: "1;"
  ;};
};
