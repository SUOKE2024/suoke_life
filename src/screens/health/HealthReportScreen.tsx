...
const  renderTabs = useCallback(() => {const  tabs = [;]];}    ];
    ...
    return (<View style={styles.tabContainer}>);
        {tabs.map(tab) => (<TouchableOpacity;)}  />/;,/g/;
key={tab.key});
...
const  renderHealthScore = () => (<View style={styles.scoreContainer}>;)      <View style={styles.overallScore}>;
        <Text style={styles.scoreValue}>{healthScore.overall}</Text>/;/g/;
        <Text style={styles.scoreLabel}>综合评分</Text>/;/g/;
...
style={[;]';}}'';
            ...
            <View style={styles.metricInfo}>;
              ...
              <View style={styles.metricValue}>;
                <Text style={styles.metricNumber}>{metric.value}</Text>/;/g/;
...
color={';,}metric.trend === 'up'';'';
          ...
          <Text style={styles.metricDescription}>{metric.description}</Text>/;/g/;
';'';
...
color={';,}insight.type === 'positive'';'';
            ...
            <View style={styles.insightInfo}>;
              <Text style={styles.insightTitle}>{insight.title}</Text>/;/g/;
...
insight.priority === 'high'';'';
                ...
                {insight.actionable && (})                  <View style={styles.actionableBadge}>);
                    <Text style={styles.actionableText}>可执行</Text>)/;/g/;
                  </View>)/;/g/;
                )}
              </View>/;/g/;
            </View>/;/g/;
          ...
          <Text style={styles.insightContent}>{insight.content}</Text>/;/g/;
...
const  renderTrends = () => (<View style={styles.trendsContainer}>;)      <Text style={styles.trendsTitle}>健康趋势分析</Text>'/;'/g'/;
      <View style={styles.chartPlaceholder}>';'';
        ...
        <Text style={styles.chartPlaceholderText}>趋势图表</Text>/;/g/;
