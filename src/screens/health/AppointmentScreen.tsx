...
const AppointmentScreen: React.FC<AppointmentScreenProps> = ({ navigation }) => {
  ...
  // 取消预约
  const handleCancelPress = useCallback((appointment: Appointment) => {
    selectAppointment(appointment);
  ...
  const handleReschedule = useCallback((appointment: Appointment) => {
    navigation.navigate('MedicalResourceDetail', { 
  ...
  const renderAppointmentCard = ({ item }: { item: Appointment }) => {
    const isUpcoming = new Date(item.scheduledTime) > new Date();
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              clearSpecificError('appointments');
              handleRefresh();
            }}
          >
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={loading.appointments} onRefresh={handleRefresh} />
        }
