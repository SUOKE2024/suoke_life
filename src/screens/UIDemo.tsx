...
export const UIDemo: React.FC = () => {
  ...
  return (;
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.backgrou;n;d   }]} />/      <ScrollView,
        ...
        contentContainerStyle={styles.content} />/        {// 标题区域 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h1" align="center" style={styles.title} />/            索克生活 UI 演示
          </Text>/          <Text variant="body2" align="center" color="onSurfaceVariant" />/            展示现代化的UI组件和无障碍功能
          </Text>/        </View>/
        {// 主题切换区域 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h3" style={styles.sectionTitle} />/            主题系统
        ...
        {// 文本组件演示 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h3" style={styles.sectionTitle} />/            文本组件
        ...
        {// 按钮组件演示 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h3" style={styles.sectionTitle} />/            按钮组件
          </Text>/          <Text variant="body2" color="onSurfaceVariant" style={styles.sectionDescription} />/            支持多种变体、尺寸、动画效果和无障碍功能
          </Text>/
          <View style={styles.buttonDemo} />/            {// 按钮变体 }/            <Text variant="h6" style={styles.demoSubtitle} />按钮变体</Text>/            <View style={styles.buttonRow} />/              <Button
                title="主要按钮"
                variant="primary"
            ...
            {// 按钮尺寸 }/            <Text variant="h6" style={styles.demoSubtitle} />按钮尺寸</Text>/            <View style={styles.buttonColumn} />/              <Button
                title="小按钮"
                size="small"
            ...
            {// 按钮状态 }/            <Text variant="h6" style={styles.demoSubtitle} />按钮状态</Text>/            <View style={styles.buttonRow} />/              <Button
                title="加载中"
                loading={true}
            ...
            {// 动画效果 }/            <Text variant="h6" style={styles.demoSubtitle} />动画效果</Text>/            <View style={styles.buttonRow} />/              <Button
                title="缩放动画"
                animationType="scale"
        ...
        {// 无障碍功能演示 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h3" style={styles.sectionTitle} />/            无障碍功能
          ...
          />/        </View>/
        {// 响应式设计演示 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h3" style={styles.sectionTitle} />/            响应式设计
        ...
        {// 中医特色展示 }/        <View style={[styles.section, { backgroundColor: theme.colors.surface}]} />/          <Text variant="h3" style={styles.sectionTitle} />/            中医特色设计
