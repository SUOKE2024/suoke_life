/importText from "../components/ui/Text/importButton  from ";../components/ui/Button";/import ThemeToggle from ../components/ui/ThemeToggle"/const AccessibilityPanel = React.lazy(() () () => import('../components/ui/AccessibilityPanel/import Modal from ;../components/ui/    Modal;))''/;,'/g'/;
import { usePerformanceMonitor } from "))../hooks/usePerformanceMonitor/      View,";""/;"/g"/;
/"/;"/g"/;
// 索克生活 - UI组件演示页面   展示所有新的UI组件和功能"/;,"/g"/;
...
const handleButtonPress = useCallback() => {;}    //;/;/g/;
...
return (;);
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.backgrou;n;d   }}]}  />/          <ScrollView,  />/;,/g/;
...
contentContainerStyle={styles.content} />/        {/;}///                索克生活 UI 演示"/;"/g"/;
        ...
        {///                文本组件"}""/;"/g"/;
          ...
          <View style={styles.textDemo}>/            <Text variant="h1"  />标题 H1</Text>/            <Text variant="h2"  />标题 H2</Text>/            <Text variant="h3"  />标题 H3</Text>/            <Text variant="h4"  />标题 H4</Text>/            <Text variant="h5"  />标题 H5</Text>/            <Text variant="h6"  />标题 H6</Text>/            <Text variant="body1"  />正文 Body1 - 这是主要的正文文本样式</Text>/            <Text variant="body2"  />正文 Body2 - 这是次要的正文文本样式</Text>/            <Text variant="caption"  />说明文字 Caption - 用于图片说明或辅助信息</Text>/            <Text variant="overline"  />上标文字 OVERLINE</Text>/            <Text variant="button" onPress={() =  /> handleButtonPress("文本按钮")}>/                  可点击的按钮文本"/;"/g"/;
            </Text>/            <Text variant="link" onPress={() =  /> handleButtonPress(链接")}>/                  这是一个链接文本""/;"/g"/;
            </Text>/          </View>/        </View>/"/;"/g"/;
        {///                按钮组件"}""/;"/g"/;
...
";,"";
variant="ghost";
onPress={() = accessibilityLabel="操作按钮" /> handleButtonPress("幽灵)}/              />/            </View>/    ""/;"/g"/;
            <View style={styles.buttonRow}>/                  <Button;"  />/;"/g"/;
";,"";
variant="danger";
...
";,"";
variant="success";
onPress={() = accessibilityLabel="操作按钮" /> handleButtonPress(成功")}/              />/            </View>/    ""/;"/g"/;
            {///                  <Button;"  />/;}";"/g"/;
}
                size="small"}";,"";
...
";,"";
size="xlarge";
onPress={() = accessibilityLabel="操作按钮" /> handleButtonPress("超大)}/              />/            </View>/    ""/;"/g"/;
            {///                  <Button;  />/;}}/g/;
}";,"";
loading={true}";,"";
...
";,"";
disabled={true}";,"";
onPress={() = accessibilityLabel="操作按钮" /> handleButtonPress(禁用")}/              />/            </View>/    ""/;"/g"/;
            {///                  <Button;"  />/;}";"/g"/;
}
                animationType="scale"}";,"";
...
";,"";
variant="outline";
onPress={() = accessibilityLabel="操作按钮" /> setShowAccessibilityPanel(true)}/                accessibilityHint="打开无障碍功能配置面板""/;"/g"/;
          />/        </View>/"/;"/g"/;
        {///                响应式设计"}""/;"/g"/;
...
onClose={() = /> setShowAccessibilityPanel(false)}/            animationType="slide""/;"/g"/;
      >;
        <AccessibilityPanel;  />/;,/g/;
onClose={() = /> setShowAccessibilityPanel(false)}/        />/      </Modal>/    </SafeAreaView>/      );/;/g/;
};
