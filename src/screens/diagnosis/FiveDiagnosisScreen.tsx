...
switch (currentStep) {}
      const case = DiagnosisStep.PREPARATION:}
        return (<View style={styles.stepContent;}>;)            <Text style={styles.stepDescription}>{config.description}</Text>
