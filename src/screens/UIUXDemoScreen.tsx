    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <Text style={getResponsiveStyle(styles.title)}>UI/UX优化演示</Text>
          <Text style={getResponsiveStyle(styles.subtitle)}>
            体验流畅的动画效果和性能优化
          </Text>
        </View>

        {/* 控制面板 */}
        <View style={[styles.section, visualEffectManager.generateShadowStyle()]}>
        ...
        <View style={[styles.section, visualEffectManager.generateShadowStyle()]}>
          ...
          <View style={styles.buttonGrid}>
            ...
            <TouchableOpacity
              ...
              disabled={!enableAnimations}
            >
              <Ionicons name="radio-button-off" size={20} color="#ffffff" />
        ...
        <View style={[styles.section, visualEffectManager.generateShadowStyle()]}>
          ...
          <View style={styles.performanceButtons}>
            ...
            >
              ...
              <Text style={styles.buttonText}>清理动画</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        {/* 响应式设计演示 */}
        <View style={[styles.section, visualEffectManager.generateShadowStyle()]}>
          <Text style={styles.sectionTitle}>响应式设计</Text>
          
          <View style={styles.responsiveDemo}>
            <Text style={getResponsiveStyle(styles.responsiveText)}>
              这是响应式文本，会根据屏幕尺寸自动调整大小
            </Text>
            
            <View style={getResponsiveStyle(styles.responsiveBox)}>
              <Text style={getResponsiveStyle(styles.responsiveBoxText)}>
                响应式容器
              </Text>
            </View>
          </View>
        ...
        {/* 视觉效果演示 */}
        <View style={[styles.section, visualEffectManager.generateShadowStyle()]}>
          <Text style={styles.sectionTitle}>视觉效果</Text>
          
          <View style={styles.visualEffectsDemo}>
            <View style={[styles.effectBox, visualEffectManager.generateShadowStyle()]}>
              <Text style={styles.effectBoxText}>阴影效果</Text>
            </View>
            
            <View style={[styles.effectBox, visualEffectManager.generateGlassmorphismStyle()]}>
              <Text style={styles.effectBoxText}>毛玻璃效果</Text>
            </View>
          </View>
        </View>
