...
const healthPercentage = (onlineServices / totalServices) * 100;/;/g/;
...
return (<SafeAreaView style={styles.container}>);
      <View style={styles.header}>);
        ...
        <Text style={styles.title}>服务状态</Text>/;/g/;
        <TouchableOpacity onPress={runQuickCheck} disabled={loading}>;
          <Text style={styles.quickCheckButton}>快速检查</Text>/;/g/;
        </TouchableOpacity>/;/g/;
      </View>/;/g/;
...
';'';
        {loading && !refreshing ? (<View style={styles.loadingContainer}>';)            <ActivityIndicator size="large" color="#3498DB"  />")""/;"/g"/;
