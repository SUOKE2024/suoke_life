...
const AIHealthAssistantScreen: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'chat' | 'tips' | 'analysis'>('chat');
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'ai',
      content: '您好！我是您的AI健康助手小艾。我可以帮您分析健康状况、提供个性化建议、回答健康问题。请问今天有什么可以帮助您的吗？',
      timestamp: '09:00',
      suggestions: ['我想了解我的健康状况', '最近感觉疲劳怎么办', '如何改善睡眠质量'],
    },
    {
      id: '2',
      type: 'user',
  ...
  const healthTips = [
    {
      id: '1',
      title: '保持充足睡眠',
      content: '每晚保证7-8小时的优质睡眠，有助于身体恢复和免疫力提升。建议23:00前入睡，避免睡前使用电子设备。',
      category: '睡眠健康',
      icon: 'sleep',
    ...
    },
    {
      id: '2',
      title: '均衡营养摄入',
      content: '多吃新鲜蔬果，适量摄入优质蛋白质，减少加工食品。每日饮水量保持在1.5-2升。',
      category: '营养饮食',
      icon: 'food-apple',
      priority: 'high' as const,
    },
    {
      id: '3',
      title: '规律运动锻炼',
      content: '每周至少150分钟中等强度运动，可以选择快走、游泳、骑行等有氧运动。',
      category: '运动健身',
      icon: 'run',
    ...
    },
    {
      id: '4',
      title: '管理情绪压力',
      content: '学会放松技巧，如深呼吸、冥想、瑜伽等。保持积极心态，及时排解负面情绪。',
      category: '心理健康',
      icon: 'meditation',
      priority: 'medium' as const,
    },
    ...
    <View style={styles.analysisContainer}>
      ...
      <View style={styles.metricsCard}>
        ...
        <View style={styles.metricsList}>
          {[
            { name: '睡眠质量', score: 78, status: '良好', color: colors.primary },
            { name: '运动活跃度', score: 65, status: '一般', color: colors.warning },
            { name: '营养均衡', score: 88, status: '优秀', color: colors.success },
            { name: '心理状态', score: 92, status: '优秀', color: colors.success },
          ].map((metric, index) => (
