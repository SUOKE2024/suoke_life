...
import {ModelPerformance} fromodelTrainingService,"
TrainingData,";
}
    TrainingStatus,'}
...
const status = TrainingStatusperformance?: ModelPerformance;
...
const  getSelectedModelDetails = () => {if (!selectedModel) return nullconst status = trainingStatuses.find(s => s.modelId === selectedModel);
...
if (!details.status) return null;
                ...
                return (<View>})                    <Text style={styles.modalSectionTitle}>训练状态</Text>
                    ...
                    {details.performance && (<>})                        <Text style={styles.modalSectionTitle}>性能指标</Text>
                        <View style={styles.modalDetailItem}>);
