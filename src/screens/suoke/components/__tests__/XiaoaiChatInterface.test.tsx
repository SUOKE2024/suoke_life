...
import XiaoaiChatInterface from '../XiaoaiChatInterface';
...
describe('XiaoaiChatInterface', (); => {
  ...
  it('should render without crashing', (); => {
    ...
    expect(screen.getByTestId('xiaoaichatinterface');).toBeTruthy();
  })
...
import {  } from '../XiaoaiChatInterface';
describe('XiaoaiChatInterface Performance Tests', () => {
