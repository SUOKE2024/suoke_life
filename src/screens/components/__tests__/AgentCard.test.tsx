...
describe('AgentCard', (); => {
  ...
  it('should initialize with correct default values', (); => {
    const { result   } = renderHook((); => AgentCard(), { wrapper });
  ...
  it('should cleanup resources on unmount', (); => {
    const { unmount   } = renderHook((); => AgentCard(), { wrapper });
    // Test cleanup
    unmount();
...
import { AGENTS, AgentCard } from '../AgentCard';
describe('AgentCard Performance Tests', () => {
