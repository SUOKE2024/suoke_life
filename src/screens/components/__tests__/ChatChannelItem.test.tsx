...
import { configureStore } from @reduxjs/toolkit"/import ChatChannelItem from "../ChatChannelItem";/";
...
describe("ChatChannelItem Performance Tests, () => {", () => {
