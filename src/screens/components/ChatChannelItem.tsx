...
onPress={handlePress};";,"";
activeOpacity={0.7} />/      <View style={styles.avatarContainer}>/        <View style={[styles.avatar, { backgroundColor: getChannelColor + "20   ;}}]}  />/          <Text style={styles.avatarText}>{channel.avatar}</Text>/        </View>/        {channel.isOnline && <View style={styles.onlineIndicator}>}/      </View>/    ""/;"/g"/;
      <View style={styles.content}>/        <View style={styles.header}>/          <View style={styles.nameContainer}>/            <Text style={styles.name} numberOfLines={1}  />/                  {channel.name}/;/g/;
        ...
        {channel.specialization  && <Text style={[styles.specialization, { color: getChannelColor()   ;}}]} numberOfLines={1}  />/                {channel.specialization}/;/g/;
          </Text>/            )}/;/g/;
