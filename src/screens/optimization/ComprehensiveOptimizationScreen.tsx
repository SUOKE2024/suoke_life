...
type: OptimizationType,'name: string,'
...
try {// 模拟优化过程/for (let i = 0; i < optimizationStatuses.length; i++) {const optimization = optimizationStatuses[i];}        // 更新状态为运行中
...
style={}[;]}
      ...
      {optimization.result && (<View style={styles.resultContainer}>;)          <Text style={styles.resultTitle}>优化结果:</Text>)
