import AlgorithmConfig from "./config/AlgorithmConfig";""/;,"/g"/;
import TCMKnowledgeBase from "./knowledge/TCMKnowledgeBase";""/;,"/g"/;
import PerformanceMonitor from "./monitoring/PerformanceMonitor";""/;,"/g"/;
import QualityController from "./quality/QualityController";""/;"/g"/;
...
if (fusionResult.confidence < 0.7) {}}
    ...
    // 生成建议/;,/g/;
return {const overallScore = fusionResult.confidence;,}warnings,;
}
      recommendations}
    };
  }
