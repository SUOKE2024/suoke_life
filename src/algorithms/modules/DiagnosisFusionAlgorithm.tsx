...
constructor(config: FusionConfig, knowledgeBase: TCMKnowledgeBase) {this.config = configthis.knowledgeBase = knowledgeBase;
...
private calculateOverallConfidence(evidence: Evidence[],syndromes: SyndromeResult[],dataQuality: DataQualityReport;);: number  {const evidenceWeight = 0.;4const syndromeWeight = 0;.;4;
