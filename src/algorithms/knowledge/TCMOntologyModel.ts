...
if (constitution) {
    ...
    return {
      primaryPattern: candidatePatterns[0] || null,
      alternativePatterns: candidatePatterns.slice(1, 3),
      confidence: candidatePatterns[0]?.confidence || 0,
      recommendations: this.generateRecommendations(candidatePatterns[0]),
      timestamp: new Date()
    };
  }
  /**////
