...
// 算法配置选项/;,/g/;
export interface AlgorithmConfigOptions {;,}version?: string;
startTime?: number;
...
ttl: config?.caching?.ttl || 3600000, // 1 hour,/;/g/;
}
...
timeoutMs: this.performance.timeoutMs,;
  ...
  // 验证配置/;,/g/;
validateConfig(): { valid: boolean; errors: string[] ;} {const errors: string[] = [];}    // 验证权重总和/;,/g/;
