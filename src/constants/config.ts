...
export const API_CONFIG = {
  // 基础配置
  BASE_URL: __DEV__ ? 'http://localhost:8000' : 'https://api.suokelife.com',
  TIMEOUT: 30000,
  RETRY_ATTEMPTS: 3,
  RETRY_DELAY: 1000,
  ...
  // 智能体服务端点
  AGENTS: {
    XIAOAI: __DEV__ ? 'http://localhost:50051' : 'https://xiaoai.suokelife.com',
    XIAOKE: __DEV__ ? 'http://localhost:9083' : 'https://xiaoke.suokelife.com',
    LAOKE: __DEV__ ? 'http://localhost:8080' : 'https://laoke.suokelife.com',
    SOER: __DEV__ ? 'http://localhost:8054' : 'https://soer.suokelife.com',
  },

  // 四诊服务端点
  DIAGNOSIS: {
    LOOK: __DEV__ ? 'http://localhost:8001' : 'https://look.suokelife.com',
    LISTEN: __DEV__ ? 'http://localhost:8002' : 'https://listen.suokelife.com',
    INQUIRY: __DEV__
      ? 'http://localhost:8003'
      : 'https://inquiry.suokelife.com',
    PALPATION: __DEV__
      ? 'http://localhost:8004'
      : 'https://palpation.suokelife.com',
  },

  // 其他服务端点
  SERVICES: {
    AUTH: __DEV__ ? 'http://localhost:8010' : 'https://auth.suokelife.com',
    USER: __DEV__ ? 'http://localhost:8011' : 'https://user.suokelife.com',
    HEALTH: __DEV__ ? 'http://localhost:8012' : 'https://health.suokelife.com',
    BLOCKCHAIN: __DEV__
      ? 'http://localhost:8013'
      : 'https://blockchain.suokelife.com',
    RAG: __DEV__ ? 'http://localhost:8014' : 'https://rag.suokelife.com',
    GATEWAY: __DEV__
      ? 'http://localhost:8000'
      : 'https://gateway.suokelife.com',
  },
};
