...
分类配置 * export const SERVICE_CATEGORIES: CategoryConfig[] = [{
  ...
  {
      key: "diagnosis",
      label: "五诊", icon: "stethoscope", color: "#34C759"},
  {
      key: "eco",
      label: "生态服务", icon: "leaf", color: "#32D74B"},
  {
      key: "product",
      label: "产品", icon: "package-variant", color: "#8E44AD"},
  {
      key: "service",
      label: "服务", icon: "medical-bag", color: "#E74C3C"},
  {
      key: "subscription",
      label: "订阅",
    icon: "calendar-check",
  ...
  {
      key: "market",
      label: "市集", icon: "store", color: "#27AE60"},
  {
      key: "custom",
      label: "定制", icon: "cog", color: "#9B59B6"},
  {
      key: "supplier",
