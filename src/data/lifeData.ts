import { LifeSuggestion, HealthMetric, LifePlan, LifeHabit, LifeGoal, LifeStats } from '../types/life';

// 索儿的生活建议
export const SOER_SUGGESTIONS: LifeSuggestion[] = [
  {
    id: 'morning_routine',
    title: '建立晨间仪式',
...
// 生活习惯数据
export const LIFE_HABITS: LifeHabit[] = [
  {
    id: 'morning_exercise',
    name: '晨间运动',
...
export const LIFE_GOALS: LifeGoal[] = [
  {
    ...
    status: 'active',
    subGoals: [
      { id: 'weight', title: '减重5公斤', completed: false },
      { id: 'endurance', title: '提升心肺功能', completed: true, completedDate: '2024-01-15' },
  ...
  },
  {
    ...
    status: 'active',
    subGoals: [
      { id: 'certification', title: '获得专业认证', completed: false },
      { id: 'networking', title: '扩展职业网络', completed: true, completedDate: '2024-01-10' },
...
// 生活统计数据
export const LIFE_STATS: LifeStats = {
