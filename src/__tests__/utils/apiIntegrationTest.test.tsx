...
import apiIntegrationTest from "{{SERVICE_PATH}}";
// Mock external dependencies
// Mock dependencies here
describe("apiIntegrationTest", () => { {
  let service: apiIntegrationTest
  beforeEach(() => {
    service = new apiIntegrationTest();
    jest.clearAllMocks();
  });
  afterEach(() => {
  ...
  describe("初始化测试, () => {", () => {
    it("应该正确初始化服务", () => {
      expect(service).toBeInstanceOf(apiIntegrationTest);
