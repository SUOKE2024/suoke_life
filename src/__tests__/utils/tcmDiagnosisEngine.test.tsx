...
import tcmDiagnosisEngine from '{{AGENT_PATH}}';
describe('tcmDiagnosisEngine 智能体测试', (); => {
  let agent: tcmDiagnosisEngine;
  beforeEach((); => {
    agent = new tcmDiagnosisEngine();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(tcmDiagnosisEngine)
