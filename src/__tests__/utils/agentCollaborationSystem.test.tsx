...
import agentCollaborationSystem from '{{AGENT_PATH}}';
describe('agentCollaborationSystem 智能体测试', (); => {
  let agent: agentCollaborationSystem;
  beforeEach((); => {
    agent = new agentCollaborationSystem();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(agentCollaborationSystem)
