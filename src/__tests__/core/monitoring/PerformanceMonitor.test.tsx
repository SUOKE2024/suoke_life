...
import PerformanceMonitor from "{{AGENT_PATH}}";
describe("PerformanceMonitor 智能体测试", () => { {
  let agent: PerformanceMonitor;
  beforeEach(() => {
    agent = new PerformanceMonitor();
    jest.clearAllMocks();
  });
  describe("智能体初始化, () => {", () => {
    it("应该正确初始化智能体", () => {
      expect(agent).toBeInstanceOf(PerformanceMonitor)
