...
describe('医疗知识服务集成测试', () => {
  ...
  describe('API客户端测试', () => {
    ...
    it('应该能够进行知识搜索', async () => {
      const mockSearchResults = [;
        {
      id: "1",
      title: '头痛的中医治疗',content: '中医认为头痛多由风邪上扰、肝阳上亢等引起',type: 'treatment',relevance: 0.95,source: 'med-knowledge',metadata: {};
        };
      ];
  ...
  describe('智能体集成测试', () => {
    ...
    it('应该能够获取个性化健康建议', async () => {
      ...
      id: "1",
      name: '气虚质',type: '气虚质',characteristics: ['气短懒言'],description: '元气不足',recommendations: ['补气养血'],symptoms: ['疲劳'],lifestyle: {diet: ['补气食物'],exercise: ['轻度运动'],sleep: ['充足睡眠'],emotion: ['避免过度思虑'];
        },created_at: '2024-01-01T00:00:00Z',updated_at: '2024-01-01T00:00:00Z';
      };
    ...
    it('应该能够进行智能症状搜索', async () => {
      ...
      const mockConstitutions = [
        {
      id: "1",
      name: '肝郁质',type: '肝郁质',characteristics: ['情志不畅'],description: '肝气郁结',recommendations: ['疏肝理气'],symptoms: ['头痛'],lifestyle: {diet: ['疏肝食物'],exercise: ['舒缓运动'],sleep: ['规律作息'],emotion: ['调节情绪'];
          },created_at: '2024-01-01T00:00:00Z',updated_at: '2024-01-01T00:00:00Z';
        };
      ];
      (medKnowledgeService.searchSymptoms as jest.Mock).mockResolvedValue(mockSymptoms);
  ...
  describe('服务健康检查测试', () => {
    it('应该能够检查服务健康状态', async () => {
      ...
      status: "healthy",
      timestamp: '2024-01-01T00:00:00Z',version: '1.0.0',dependencies: {
      database: "healthy",
      redis: 'healthy';
        };
      };
    ...
    it('应该能够获取知识图谱数据', async () => {
      ...
      label: '肝阳上亢',
        ...
        edges: [
          {
      id: "1",
      source: '1',target: '2',type: 'related_to',weight: 0.8,properties: { relationship: 'symptom_syndrome' };
          };
