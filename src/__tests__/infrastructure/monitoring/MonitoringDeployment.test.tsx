...
import MonitoringDeployment from "{{SERVICE_PATH}}";
// Mock external dependencies
// Mock dependencies here
describe("MonitoringDeployment", () => { {
  let service: MonitoringDeployment
  beforeEach(() => {
    service = new MonitoringDeployment();
    jest.clearAllMocks();
  });
  afterEach(() => {
  ...
  describe("初始化测试, () => {", () => {
    it("应该正确初始化服务", () => {
      expect(service).toBeInstanceOf(MonitoringDeployment);
