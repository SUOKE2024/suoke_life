...
import AgentSelector from '{{AGENT_PATH}}';
describe('AgentSelector 智能体测试', (); => {
  let agent: AgentSelector;
  beforeEach((); => {
    agent = new AgentSelector();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(AgentSelector)
