...
import ChatChannelItem from "{{AGENT_PATH}}";
describe("ChatChannelItem 智能体测试", () => { {
  let agent: ChatChannelItem;
  beforeEach(() => {
    agent = new ChatChannelItem();
    jest.clearAllMocks();
  });
  describe("智能体初始化, () => {", () => {
    it("应该正确初始化智能体", () => {
      expect(agent).toBeInstanceOf(ChatChannelItem)
