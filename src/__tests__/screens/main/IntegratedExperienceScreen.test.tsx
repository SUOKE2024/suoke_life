...
import IntegratedExperienceScreen from '{{AGENT_PATH}}';
describe('IntegratedExperienceScreen 智能体测试', (); => {
  let agent: IntegratedExperienceScreen;
  beforeEach((); => {
    agent = new IntegratedExperienceScreen();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(IntegratedExperienceScreen)
