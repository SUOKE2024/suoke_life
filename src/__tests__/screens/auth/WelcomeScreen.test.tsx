...
import WelcomeScreen from '{{AGENT_PATH}}';
describe('WelcomeScreen 智能体测试', (); => {
  let agent: WelcomeScreen;
  beforeEach((); => {
    agent = new WelcomeScreen();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(WelcomeScreen)
