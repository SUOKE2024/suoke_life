...
import ApiIntegrationDemo from "{{AGENT_PATH}}";
describe("ApiIntegrationDemo 智能体测试", () => { {
  let agent: ApiIntegrationDemo;
  beforeEach(() => {
    agent = new ApiIntegrationDemo();
    jest.clearAllMocks();
  });
  describe("智能体初始化, () => {", () => {
    it("应该正确初始化智能体", () => {
      expect(agent).toBeInstanceOf(ApiIntegrationDemo)
