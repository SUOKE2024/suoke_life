...
import AgentUsageExample from '{{SERVICE_PATH}}';
// Mock external dependencies
// Mock dependencies here
describe('AgentUsageExample', (); => {
  let service: AgentUsageExample;
  beforeEach((); => {
    service = new AgentUsageExample();
    jest.clearAllMocks();
  });
  afterEach((); => {
  ...
  describe('初始化测试', () => {
    it('应该正确初始化服务', (); => {
      expect(service).toBeInstanceOf(AgentUsageExample);
