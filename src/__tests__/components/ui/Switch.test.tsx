...
import Switch from '{{COMPONENT_PATH}}';
// Mock dependencies
...
describe('Switch', (); => {
  ...
  describe('交互测试', () => {
    it('应该处理用户点击事件', async (); => {
      ...
      render(<Switch {...defaultProps} onPress={mockOnPress} />)
