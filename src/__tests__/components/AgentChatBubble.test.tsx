...
import AgentChatBubble from '{{AGENT_PATH}}';
describe('AgentChatBubble 智能体测试', (); => {
  let agent: AgentChatBubble;
  beforeEach((); => {
    agent = new AgentChatBubble();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(AgentChatBubble)
