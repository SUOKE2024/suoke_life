...
import AgentEmotionFeedback from '{{AGENT_PATH}}';
describe('AgentEmotionFeedback 智能体测试', (); => {
  let agent: AgentEmotionFeedback;
  beforeEach((); => {
    agent = new AgentEmotionFeedback();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(AgentEmotionFeedback)
