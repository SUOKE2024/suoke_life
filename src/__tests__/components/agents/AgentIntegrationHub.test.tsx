...
import AgentIntegrationHub from '{{AGENT_PATH}}';
describe('AgentIntegrationHub 智能体测试', (); => {
  let agent: AgentIntegrationHub;
  beforeEach((); => {
    agent = new AgentIntegrationHub();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(AgentIntegrationHub)
