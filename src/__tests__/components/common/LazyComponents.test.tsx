...
import LazyComponents from '{{AGENT_PATH}}';
describe('LazyComponents 智能体测试', (); => {
  let agent: LazyComponents;
  beforeEach((); => {
    agent = new LazyComponents();
    jest.clearAllMocks();
  })
  describe('智能体初始化', () => {
    it('应该正确初始化智能体', (); => {
      expect(agent).toBeInstanceOf(LazyComponents)
