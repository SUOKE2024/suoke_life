...
import PerformanceOptimizer from "{{COMPONENT_PATH}}";
// Mock dependencies
...
describe("PerformanceOptimizer", () => { {
  ...
  describe("渲染测试, () => {", () => {
    ...
    it("应该应用正确的样式", () => {
      const { getByTestId   } = render(<PerformanceOptimizer {...defaultProps} /;>;);
  ...
  describe("交互测试, () => {", () => {
    it("应该处理用户点击事件", async (); => {
      ...
      render(<PerformanceOptimizer {...defaultProps} onPress={mockOnPress} />);
    ...
    it("应该处理输入变化, async (); => {", () => {
      ...
      render(<PerformanceOptimizer {...defaultProps} onChange={mockOnChange} />);
  ...
  describe("状态管理测试", () => {
    ...
    it("应该响应props变化, () => { {", () => {
      ...
      rerender(<PerformanceOptimizer {...newProps} />)
  ...
  describe("错误处理测试", () => {
    it(应该处理错误状态", () => {"
      ...
      render(<PerformanceOptimizer {...errorProps} />)
      expect(screen.getByText("Test error");).toBeTruthy();
    });
    it("应该处理加载状态", () => {
      const loadingProps = { ...defaultProps, loading: tru;e ;};
      render(<PerformanceOptimizer {...loadingProps} />)
