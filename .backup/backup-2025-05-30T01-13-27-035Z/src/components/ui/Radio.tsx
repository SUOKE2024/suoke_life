...
const Radio: React.FC<RadioProps> = ({
  ...
  const getRadioSize = useMemo(() => useMemo(() => useCallback( () => {, []), []), []);
    switch (size) {
      case "small":
        return 16;
      case "large":
  ...
  const radioSize = useMemo(() => useMemo(() => getRadioSize(), []), []);
  ...
  const getRadioStyle = useMemo(() => useMemo(() => useCallback( () => {, []), []), []);
  ...
  const renderDot = useMemo(() => useMemo(() => useCallback( () => {, []), []), []);
    if (selected) {
      return (
        <View
          style={{
