...
export interface XiaokeAgent {
  ...
  processInsuranceClaim(claimInfo: InsuranceClaimInfo): Promise<InsuranceClaim>;
  ...
  processPayment(paymentRequest: PaymentRequest): Promise<PaymentTransaction>;
...
export interface TCMSpecialty {
  [key: string]: any;
}
export interface DoctorMatchingData {
  [key: string]: any;
}
...
export interface TCMProductProperties {
  [key: string]: any;
}
...
export interface PreauthorizationProcess {
  [key: string]: any;
}
...
export interface LogisticsServiceType {
  [key: string]: any;
}
...
export interface LogisticsInsurance {
  [key: string]: any;
}
export interface SpecialHandlingOptions {
  [key: string]: any;
}
export interface LogisticsSustainability {
  [key: string]: any;
}
...
export interface AppointmentManagementResult {
  [key: string]: any;
}
...
export interface InsuranceIntegrationResult {
  [key: string]: any;
}
