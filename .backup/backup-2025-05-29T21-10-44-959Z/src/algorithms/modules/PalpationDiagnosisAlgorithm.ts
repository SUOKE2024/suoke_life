...
export class PalpationDiagnosisAlgorithm {
  ...
  private async preprocessData(
    data: PalpationData
  ): Promise<ProcessedPalpationData> {
  ...
  private async processSignals(
    data: ProcessedPalpationData
  ): Promise<ProcessedSignalData> {
  ...
  private async preprocessTemperatureData(
    data: TemperatureData
  ...
  private async preprocessPressureData(
    data: PressureData
