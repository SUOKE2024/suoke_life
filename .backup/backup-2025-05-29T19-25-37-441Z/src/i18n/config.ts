...
// 支持的语言类型
export type SupportedLanguage = 'zh-CN' | 'zh-TW' | 'en-US' | 'en-GB' | 'ar-SA' | 'he-IL' | 'ja-JP' | 'ko-KR';

// RTL语言列表
export const RTL_LANGUAGES: SupportedLanguage[] = ['ar-SA', 'he-IL'];
...
// 默认文化偏好
export const DEFAULT_CULTURAL_PREFERENCES: CulturalPreferences = {
  colorScheme: 'auto',
  accentColor: '#35bb78',
  fontSize: 'medium',
...
// 获取语言的地区代码
export const getRegionFromLanguage = (language: SupportedLanguage): string => {
  return language.split('-')[1] || 'CN';
};
