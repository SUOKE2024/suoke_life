import { ContentItem, CategoryConfig, HotTopic, CategoryType } from '../types/explore';
...
export const LAOKE_WISDOM: ContentItem[] = [
  {
    ...
    difficulty: 'beginner',
    featured: true,
    description: '中医认为，人体应顺应四季变化调养脏腑，春季重在养肝疏泄，夏季注重养心安神，秋季着重养肺润燥，冬季专注养肾藏精。',
  },
  {
    id: 'wisdom_2',
    title: '药食同源话山药',
    ...
    description: '山药性平味甘，归脾、肺、肾经，具有补脾养胃、生津益肺、补肾涩精的功效。',
  },
  {
    id: 'wisdom_3',
    title: '太极拳入门心法',
    ...
    difficulty: 'beginner',
    featured: true,
    description: '太极拳是中华武术的瑰宝，以柔克刚，以静制动，通过缓慢连贯的动作调和气血。',
  },
  {
    id: 'wisdom_4',
    title: '足三里穴的妙用',
    ...
    tags: ['足三里', '穴位按摩', '保健养生'],
    difficulty: 'beginner',
    description: '足三里是足阳明胃经的重要穴位，位于小腿外侧，具有调理脾胃、增强体质的作用。',
  },
  {
    id: 'wisdom_5',
    title: '五行学说与体质调养',
    ...
    difficulty: 'advanced',
    description: '五行学说是中医理论的重要组成部分，通过木、火、土、金、水五行相生相克关系指导养生。',
  },
  {
    id: 'wisdom_6',
    title: '枸杞菊花茶的养生秘密',
...
export const RECOMMENDED_SEARCHES = [
  '春季养生', '中医体质', '食疗方', '穴位按摩', '太极拳',
  '八段锦', '五行养生', '药食同源', '经络调理', '情志养生',
];
