...
describe('性能基准测试', () => {
  describe('组件渲染性能', () => {
    ...
    it('批量渲染性能测试', () => {
      ...
      expect(batchRenderTime).toBeLessThan(PERFORMANCE_THRESHOLDS.COMPONENT_RENDER_TIME * 10);
    });
  });
  ...
  describe('数据处理性能', () => {
    ...
    it('复杂数据转换性能测试', () => {
      ...
      expect(transformTime).toBeLessThan(PERFORMANCE_THRESHOLDS.DATA_PROCESSING_TIME);
    });
  });
  ...
  describe('异步操作性能', () => {
    it('Promise处理应该高效', async () => {
      ...
      expect(duration).toBeLessThan(PERFORMANCE_THRESHOLDS.ASYNC_OPERATION_TIME);
    });
  ...
  describe('算法性能', () => {
    it('排序算法性能测试', () => {
      ...
      expect(sortTime).toBeLessThan(PERFORMANCE_THRESHOLDS.ALGORITHM_EXECUTION_TIME);
    });
    ...
    it('搜索算法性能测试', () => {
      ...
      expect(searchTime).toBeLessThan(PERFORMANCE_THRESHOLDS.ALGORITHM_EXECUTION_TIME);
    });
    ...
    it('递归算法性能测试', () => {
      ...
      expect(fibTime).toBeLessThan(PERFORMANCE_THRESHOLDS.ALGORITHM_EXECUTION_TIME * 10);
    });
  });
  ...
  describe('压力测试', () => {
    it('高频操作压力测试', () => {
      ...
      expect(stressTime).toBeLessThan(PERFORMANCE_THRESHOLDS.DATA_PROCESSING_TIME);
  ...
  describe('性能回归测试', () => {
    it('复杂操作性能基准', () => {
      ...
      expect(operationTime).toBeLessThan(PERFORMANCE_THRESHOLDS.DATA_PROCESSING_TIME);
    });
    ...
    it('内存密集型操作测试', () => {
      const memoryIntensiveOperation = () => {
        const largeArrays = [];
        for (let i = 0; i < 100; i++) {
          largeArrays.push(Array.from({ length: 100 }, (_, j) => ({
            index: j,
            data: `Item ${i}-${j}`,
