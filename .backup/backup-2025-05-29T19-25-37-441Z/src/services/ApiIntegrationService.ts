...
export class ApiIntegrationService {
  ...
  async getAgentPerformance(agentId: string, timeRange?: { start: string; end: string }) {
    try {
      const response = await apiClient.get(`/agents/${agentId}/performance`, timeRange);
      return response.data;
    } catch (error) {
  ...
  async updateAgentSettings(agentId: string, settings: any) {
    try {
      const response = await apiClient.put(`/agents/${agentId}/settings`, settings);
  ...
  async getBlockchainHealthRecords(userId: string): Promise<BlockchainHealthRecord[]> {
    try {
      const response = await apiClient.get(`/blockchain/health-records/${userId}`);
      return response.data;
    } catch (error) {
  ...
  async bookMedicalAppointment(resourceId: string, appointmentData: {
    ...
    try {
      const response = await apiClient.post(`/medical-resources/${resourceId}/appointments`, {
        ...appointmentData,
        timestamp: new Date().toISOString(),
      });
  ...
  async getRecommendedKnowledge(userId: string, context?: any): Promise<KnowledgeResult[]> {
    try {
      const response = await apiClient.get(`/knowledge/recommendations/${userId}`, { context });
      return response.data;
    } catch (error) {
  ...
  async updateAccessibilitySettings(userId: string, settings: any) {
    try {
      const response = await apiClient.put(`/accessibility/settings/${userId}`, settings);
  ...
  async subscribeToEcoService(userId: string, serviceId: string, plan: string) {
    try {
      const response = await apiClient.post(`/eco-services/${serviceId}/subscribe`, {
        userId,
        plan,
        timestamp: new Date().toISOString(),
      });
  ...
  async getEcoServiceUsage(userId: string, serviceId: string) {
    try {
      const response = await apiClient.get(`/eco-services/${serviceId}/usage/${userId}`);
      return response.data;
    } catch (error) {
