...
// 消息类型
export type MessageType = 'ping' | 'pong' | 'subscribe' | 'unsubscribe' | 'data' | 'error' | 'auth';
...
export class WebSocketManager extends EventEmitter {
  ...
  private scheduleReconnect(): void {
    ...
    const delay = Math.min(
      this.config.reconnect.delay * Math.pow(this.config.reconnect.backoffMultiplier, this.reconnectAttempts),
