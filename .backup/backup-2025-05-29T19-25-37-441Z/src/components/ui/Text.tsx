...
import { Text as RNText, StyleSheet, TextStyle, AccessibilityRole } from 'react-native';
...
export interface TextProps {
  ...
  // 样式属性
  color?: 'primary' | 'secondary' | 'onSurface' | 'onSurfaceVariant' | 'onPrimary' | 'onSecondary' | 'error' | 'success' | 'warning' | 'info' | string;
...
const Text: React.FC<TextProps> = ({
  ...
  const getVariantStyle = (): TextStyle => {
    const variantStyles: Record<string, TextStyle> = {
      h1: {
        ...
        lineHeight: responsive.fontSize(theme.typography.fontSize['5xl'] * theme.typography.lineHeight.tight),
        color: theme.colors.onSurface,
      },
      h2: {
        fontSize: responsive.fontSize(theme.typography.fontSize['4xl']),
        fontWeight: '700' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize['4xl'] * theme.typography.lineHeight.tight),
        color: theme.colors.onSurface,
      },
      h3: {
        fontSize: responsive.fontSize(theme.typography.fontSize['3xl']),
        fontWeight: '600' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize['3xl'] * theme.typography.lineHeight.tight),
        color: theme.colors.onSurface,
      },
      h4: {
        fontSize: responsive.fontSize(theme.typography.fontSize['2xl']),
        fontWeight: '600' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize['2xl'] * theme.typography.lineHeight.normal),
        color: theme.colors.onSurface,
      },
      h5: {
        fontSize: responsive.fontSize(theme.typography.fontSize.xl),
        fontWeight: '600' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize.xl * theme.typography.lineHeight.normal),
        color: theme.colors.onSurface,
      },
      h6: {
        fontSize: responsive.fontSize(theme.typography.fontSize.lg),
        fontWeight: '600' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize.lg * theme.typography.lineHeight.normal),
        color: theme.colors.onSurface,
      },
      body1: {
        fontSize: responsive.fontSize(theme.typography.fontSize.base),
        fontWeight: '400' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize.base * theme.typography.lineHeight.normal),
        color: theme.colors.onSurface,
      },
      body2: {
        fontSize: responsive.fontSize(theme.typography.fontSize.sm),
        fontWeight: '400' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize.sm * theme.typography.lineHeight.normal),
        color: theme.colors.onSurfaceVariant,
      },
      caption: {
        fontSize: responsive.fontSize(theme.typography.fontSize.xs),
        fontWeight: '400' as const,
        lineHeight: responsive.fontSize(theme.typography.fontSize.xs * theme.typography.lineHeight.normal),
        color: theme.colors.onSurfaceVariant,
      },
      overline: {
        fontSize: responsive.fontSize(theme.typography.fontSize.xs),
  ...
  const getColor = (): string => {
    if (!color) {return getVariantStyle().color as string;}
  ...
  const getFontSize = (): number => {
    if (!size) {return getVariantStyle().fontSize as number;}
