...
class MCPHealthDemo:
    ...
    async def four_agent_analysis(self, health_data: List[Dict], intent: Dict) -> Dict[str, Any]:
        """四智能体协作分析"""
        ...
        # 生成共识分析
        consensus = self.generate_consensus([xiaoai_analysis, xiaoke_analysis, laoke_analysis, soer_analysis])
    ...
    def generate_unified_response(self, analysis: Dict) -> str:
        ...
        response += f"综合四个智能体的分析建议：{consensus['unified_recommendations'][0]}。"
