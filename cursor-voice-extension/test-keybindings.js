// 测试 Cursor Voice Extension 快捷键功能
console.log('🔧 Cursor 语音扩展快捷键测试');

console.log('📋 快捷键配置:');
console.log('• Cmd+Shift+V (Mac) / Ctrl+Shift+V (Windows/Linux): 切换语音模式');
console.log('');
...
console.log('4. 检查是否有语音识别开始/停止的提示');
console.log('');
...
// 模拟快捷键测试
function simulateKeybindingTest() {
    console.log('');
    console.log('🧪 模拟快捷键测试...');
