 ...
 *```
 */
declare const SegmentedButtons: <T extends string = string>({ value, onValueChange, buttons, multiSelect, density, style, theme: themeOverrides, }: Props<T>) => React.JSX.Element;
