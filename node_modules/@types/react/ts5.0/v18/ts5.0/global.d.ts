...
/*
React projects that don't include the DOM library need these export interfaces to compile.
React Native applications use React, but there is no DOM available. The JavaScript runtime
is ES6/ES2015 only. These definitions allow such projects to compile with only `--lib ES6`.

Warning: all of these export interfaces are empty. If you want type definitions for various properties
...
export interface SVGSetElement extends SVGElement {}
