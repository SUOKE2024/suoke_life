...
declare export interface GlobalFetch {
    fetch(input: RequestInfo, init?: RequestInit): Promise<Response>;
}

declare function fetch(input: RequestInfo, init?: RequestInit): Promise<Response>;

declare export interface WindowOrWorkerGlobalScope {
    fetch(input: RequestInfo, init?: RequestInit): Promise<Response>;
}
...
declare export interface Request extends Object, Body {
...
declare export interface ResponseInit {
    headers?: HeadersInit_ | undefined;
    status?: number | undefined;
    statusText?: string | undefined;
}

declare export interface Response extends Object, Body {
    readonly headers: Headers;
    readonly ok: boolean;
...
declare export interface ProgressEvent<T extends EventTarget = EventTarget> extends Event {
