...
declare namespace jest {
    ...
    export interface SpyInstance<T = any, Y extends any[] = any, C = any> extends MockInstance<T, Y, C> {}
    ...
    export interface MockContext<T, Y extends any[], C = any> {
        /**
    ...
    export interface ReplaceProperty<K> {
        /**
...
declare namespace jasmine {
    ...
    export interface ArrayContaining {
        new(sample: readonly any[]): any;
        asymmetricMatch(other: any): boolean;
        jasmineToString(): string;
    }

    export interface ObjectContaining {
        new(sample: any): any;
