...
from internal.domain.user_repository import UserRepository
from internal.application.dto import (
    CreateUserRequest, UpdateUserRequest, UserResponse,
    UserHealthSummaryResponse, BindDeviceRequest, BindDeviceResponse,
    UserDevicesResponse, VerifyUserRequest, VerifyUserResponse,
    UpdateUserPreferencesRequest
)
from pkg.errors.exceptions import (
    UserNotFoundError, UserAlreadyExistsError, InvalidCredentialsError,
    DeviceAlreadyBoundError, ValidationError
)
...
from internal.domain.repositories import HealthRepository, DeviceRepository
from internal.application.dto import (
    LoginRequest, LoginResponse, UpdateUserHealthRequest
)
