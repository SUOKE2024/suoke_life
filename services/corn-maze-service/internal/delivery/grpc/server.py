...
class CornMazeServicer(corn_maze_pb2_grpc.CornMazeServiceServicer):
    ...
    async def CreateMaze(self, request, context):
        ...
        try:
            ...
            logger.error(f"创建迷宫时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"创建迷宫失败: {e!s}")
    ...
    async def GetMaze(self, request, context):
        ...
        try:
            ...
            logger.error(f"获取迷宫时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"获取迷宫失败: {e!s}")
            return corn_maze_pb2.MazeResponse()
    ...
    async def MoveInMaze(self, request, context):
        ...
        try:
            ...
            logger.error(f"移动时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"移动失败: {e!s}")
            return corn_maze_pb2.MoveResponse(success=False, message=f"移动失败: {e!s}")
    ...
    async def GetUserProgress(self, request, context):
        ...
        try:
            ...
            logger.error(f"获取用户进度时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"获取用户进度失败: {e!s}")
            return corn_maze_pb2.UserProgressResponse()
    ...
    async def ListMazeTemplates(self, request, context):
        ...
        try:
            ...
            logger.error(f"获取迷宫模板列表时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"获取迷宫模板列表失败: {e!s}")
    ...
    async def RecordMazeCompletion(self, request, context):
        ...
        try:
            ...
            logger.error(f"记录迷宫完成时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"记录迷宫完成失败: {e!s}")
            return corn_maze_pb2.RecordMazeCompletionResponse(
                success=False,
                message=f"记录迷宫完成失败: {e!s}"
            )
    ...
    async def GetKnowledgeNode(self, request, context):
        ...
        try:
            ...
            logger.error(f"获取知识节点时出错: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"获取知识节点失败: {e!s}")
            return corn_maze_pb2.KnowledgeNodeResponse()
