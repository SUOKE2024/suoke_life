...
def main():
    ...
    try:
        ...
        if args.mode == "create":
            ...
            client.move_in_maze(args.maze_id, args.user_id, args.direction)
            ...
            client.get_user_progress(args.user_id, args.maze_id)

        elif args.mode == "templates":
            client.list_maze_templates(args.maze_type, args.difficulty)
            ...
            client.get_knowledge_node(args.node_id)
