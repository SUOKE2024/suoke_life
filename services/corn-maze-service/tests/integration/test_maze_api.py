...
class TestMazeAPIIntegration(unittest.TestCase):
    ...
    @pytest.mark.asyncio
    async def test_create_maze(self):
        """测试创建迷宫"""
        # 创建迷宫请求
    ...
    @pytest.mark.asyncio
    async def test_get_nonexistent_maze(self):
        """测试获取不存在的迷宫"""
    ...
    @pytest.mark.asyncio
    async def test_get_user_mazes(self):
        """测试获取用户的迷宫列表"""
        # 为用户创建多个迷宫
    ...
    @pytest.mark.asyncio
    async def test_search_mazes(self):
        """测试搜索迷宫"""
        # 创建一些公开迷宫
    ...
    @pytest.mark.asyncio
    async def test_update_maze(self):
        """测试更新迷宫"""
        # 首先创建一个迷宫
        create_request = pb2.CreateMazeRequest(
            user_id=self.user_id,
    ...
    @pytest.mark.asyncio
    async def test_delete_maze(self):
        """测试删除迷宫"""
        # 首先创建一个迷宫
        create_request = pb2.CreateMazeRequest(
            user_id=self.user_id,
    ...
    @pytest.mark.asyncio
    async def test_update_user_progress(self):
        """测试更新用户进度"""
        # 首先创建一个迷宫
        create_request = pb2.CreateMazeRequest(
            user_id=self.user_id,
    ...
    @pytest.mark.asyncio
    async def test_complete_maze(self):
        """测试完成迷宫"""
        # 首先创建一个迷宫
        create_request = pb2.CreateMazeRequest(
            user_id=self.user_id,
