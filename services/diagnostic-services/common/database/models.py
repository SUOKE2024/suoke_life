...
class DiagnosisSession(Base):
    ...
    session_type = Column(String(20), nullable = False, comment = "会话类型：comprehensive / single")
...
class LookAnalysis(Base):
    ...
    analysis_type = Column(String(20), nullable = False, comment = "分析类型：face / tongue / eye")
...
class ListenAnalysis(Base):
    ...
    id = Column(UUID(as_uuid = True), primary_key = True, default = uuid.uuid4)
    session_id = Column(UUID(as_uuid = True), ForeignKey("diagnosis_sessions.id"), nullable = False)
    analysis_type = Column(String(20), nullable = False, comment = "分析类型：voice / breathing / cough")
...
class PalpationAnalysis(Base):
    ...
    id = Column(UUID(as_uuid = True), primary_key = True, default = uuid.uuid4)
    session_id = Column(UUID(as_uuid = True), ForeignKey("diagnosis_sessions.id"), nullable = False)
    analysis_type = Column(String(20), nullable = False, comment = "分析类型：pulse / abdomen / acupoint")
