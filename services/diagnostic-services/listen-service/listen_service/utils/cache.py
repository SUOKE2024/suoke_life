...
import structlog
from ..models.audio_models import VoiceFeatures, AudioMetadata
...
class RedisCache(CacheBackend):
    ...
    def __init__(self, redis_url: str = "redis://localhost:6379", prefix: str = "listen_service"):
