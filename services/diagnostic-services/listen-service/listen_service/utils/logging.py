...
def setup_logging(
    ...
    processors = [
        ...
        ) if include_caller else lambda logger, method_name, event_dict: event_dict,
    ...
    if enable_console:
        ...
        if format_type == "json":
            ...
            console_formatter = ColoredFormatter() if enable_colors else PlainFormatter()
...
class PerformanceLogger:
    ...
    def log_metric(self, metric_name: str, value: Union[int, float], **kwargs) -> None:
        """记录指标"""
        self.logger.info(
            "性能指标",
