...
class TestHealthCheck(unittest.TestCase):
    ...
    def test_register_check(self):
        ...
        self.assertEqual(self.health_checker.components["test_check"].status, HealthStatus.UNKNOWN)
    ...
    async def _async_test_check_health(self):
        ...
        self.assertEqual(components["always_unhealthy"].status, HealthStatus.NOT_SERVING)
