...
from .utils import timer, cached, validate_schema
...
class TCMAnalysis:
    ...
    constitution_analysis: Optional[InferenceResult] = None
...
class TCMKnowledgeGraph(BaseService):
    ...
    def __init__(
        ...
        self.relation_index: Dict[RelationType, Set[str]] = {rt: set() for rt in RelationType}
    ...
    def _load_basic_herbs(self) -> None:
        ...
        herbs = [
            # 补气药
            {"id": "ren_shen", "name": "人参", 
             "properties": {"category": "qi_tonifying", "nature": "warm", "taste": "sweet"}},
            {"id": "huang_qi", "name": "黄芪", 
             "properties": {"category": "qi_tonifying", "nature": "warm", "taste": "sweet"}},
            {"id": "bai_zhu", "name": "白术", 
             "properties": {"category": "qi_tonifying", "nature": "warm", "taste": "sweet"}},
            ...
            # 补血药
            {"id": "dang_gui", "name": "当归", 
             "properties": {"category": "blood_tonifying", "nature": "warm", "taste": "sweet"}},
            {"id": "shu_di_huang", "name": "熟地黄", 
             "properties": {"category": "blood_tonifying", "nature": "warm", "taste": "sweet"}},
            
            # 理气药
            {"id": "chen_pi", "name": "陈皮", 
             "properties": {"category": "qi_regulating", "nature": "warm", "taste": "bitter"}},
            {"id": "chai_hu", "name": "柴胡", 
             "properties": {"category": "qi_regulating", "nature": "cool", "taste": "bitter"}},
            
            # 清热药
            {"id": "jin_yin_hua", "name": "金银花", 
             "properties": {"category": "heat_clearing", "nature": "cold", "taste": "sweet"}},
            {"id": "lian_qiao", "name": "连翘", 
             "properties": {"category": "heat_clearing", "nature": "cool", "taste": "bitter"}},
        ]
    ...
    def _load_basic_relations(self) -> None:
        ...
        relations = [
            # 症状指示证型关系
            {"source": "fatigue", "target": "qi_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.8},
            {"source": "shortness_of_breath", "target": "qi_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.7},
            {"source": "palpitation", "target": "heart_blood_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.8},
            {"source": "insomnia", "target": "heart_blood_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.7},
            {"source": "dizziness", "target": "blood_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.6},
            {"source": "abdominal_pain", "target": "spleen_qi_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.6},
            {"source": "diarrhea", "target": "spleen_qi_deficiency", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.7},
            {"source": "headache", "target": "liver_qi_stagnation", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.6},
            {"source": "chest_tightness", "target": "liver_qi_stagnation", "type": RelationType.SYMPTOM_INDICATES, "weight": 0.5},
            
            # 证型治疗方剂关系
            {"source": "qi_deficiency", "target": "si_jun_zi_tang", "type": RelationType.SYNDROME_TREATS, "weight": 0.9},
            {"source": "blood_deficiency", "target": "si_wu_tang", "type": RelationType.SYNDROME_TREATS, "weight": 0.9},
            {"source": "spleen_qi_deficiency", "target": "si_jun_zi_tang", "type": RelationType.SYNDROME_TREATS, "weight": 0.8},
            {"source": "heart_blood_deficiency", "target": "gan_mai_da_zao_tang", "type": RelationType.SYNDROME_TREATS, "weight": 0.7},
            {"source": "liver_qi_stagnation", "target": "xiao_yao_san", "type": RelationType.SYNDROME_TREATS, "weight": 0.9},
            {"source": "wind_heat", "target": "yin_qiao_san", "type": RelationType.SYNDROME_TREATS, "weight": 0.9},
            
            # 方剂包含中药关系
            {"source": "si_jun_zi_tang", "target": "ren_shen", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
            {"source": "si_jun_zi_tang", "target": "bai_zhu", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
            {"source": "si_wu_tang", "target": "dang_gui", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
            {"source": "si_wu_tang", "target": "shu_di_huang", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
            {"source": "xiao_yao_san", "target": "chai_hu", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
            {"source": "yin_qiao_san", "target": "jin_yin_hua", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
            {"source": "yin_qiao_san", "target": "lian_qiao", "type": RelationType.FORMULA_CONTAINS, "weight": 1.0},
        ]
    ...
    async def analyze_symptoms(
        ...
        try:
            ...
            # 治疗原则
            treatment_principles = await self._generate_treatment_principles(inferred_syndromes)
            ...
            analysis = TCMAnalysis(
                patient_id=patient_profile.get("patient_id", "unknown") if patient_profile else "unknown",
    ...
    async def _find_symptom_entity(self, symptom_text: str) -> Optional[KnowledgeEntity]:
        """查找症状实体"""
        ...
        for entity_id in self.entity_index[EntityType.SYMPTOM]:
            entity = self.entities[entity_id]
            similarity = await self._calculate_text_similarity(symptom_text, entity.name)
            ...
            if score >= self.confidence_threshold:
                ...
                if entity:
                    result = InferenceResult(
                        ...
                        reasoning_path=[f"症状 {symptom} 指示证型 {entity.name}" 
    ...
    async def _recommend_formulas(
        self,
        syndromes: List[InferenceResult]
            ...
            if score >= self.confidence_threshold:
                ...
                if entity:
                    result = InferenceResult(
                        ...
                        reasoning_path=[f"证型 {syndrome} 适用方剂 {entity.name}" 
    ...
    async def _analyze_constitution(
        ...
        constitution_indicators = {
            "qi_deficiency_constitution": ["fatigue", "shortness_of_breath", "low_voice"],
            "yang_deficiency_constitution": ["cold_limbs", "fatigue", "loose_stool"],
            "yin_deficiency_constitution": ["night_sweats", "dry_mouth", "insomnia"],
            "blood_stasis_constitution": ["dark_complexion", "fixed_pain", "dark_tongue"],
    ...
    async def _calculate_overall_confidence(
        ...
        syndrome_confidence = (
            sum(s.confidence for s in syndromes) / len(syndromes)
            if syndromes else 0.0
        )
