...
class RedisCache:
    ...
    def __init__(self, redis_url: str, default_ttl: int = 3600, key_prefix: str = "inquiry:"):
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            self._logger.error(f"Redis连接失败: {str(e)}")
            raise ServiceUnavailableError(f"Redis连接失败: {str(e)}", "redis")
    ...
    async def get(self, key: str) -> Optional[Any]:
        ...
        try:
            ...
            self._logger.error(f"Redis获取失败: {str(e)}")
            return None
    ...
    async def set(self, key: str, value: Any, ttl: Optional[int] = None) -> None:
        ...
        try:
            ...
            self._logger.error(f"Redis设置失败: {str(e)}")
            raise
    ...
    async def delete(self, key: str) -> bool:
        ...
        try:
            ...
            self._logger.error(f"Redis删除失败: {str(e)}")
            return False
    ...
    async def clear(self) -> None:
        ...
        try:
            ...
            self._logger.error(f"Redis清空失败: {str(e)}")
            raise
    ...
    async def exists(self, key: str) -> bool:
        ...
        try:
            ...
            self._logger.error(f"Redis存在检查失败: {str(e)}")
            return False
    ...
    async def keys(self, pattern: str = "*") -> List[str]:
        ...
        try:
            ...
            self._logger.error(f"Redis键列表获取失败: {str(e)}")
            return []
    ...
    async def stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._logger.error(f"Redis统计信息获取失败: {str(e)}")
            return {}
