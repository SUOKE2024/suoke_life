...
from .exceptions import InquiryServiceError, RateLimitError, AuthenticationError
...
class RequestTracker:
    ...
    def start_request(self, request_id: str, metadata: Dict[str, Any] = None) -> Dict[str, Any]:
        """开始跟踪请求"""
        request_info = {
    ...
    def end_request(self, request_id: str, status: str = 'completed', result: Any = None, error: str = None):
        """结束请求跟踪"""
...
class CacheMiddleware:
    ...
    async def get_or_set(self, key: str, func: Callable, *args, ttl: int = None, **kwargs):
        """获取缓存或设置缓存"""
        ...
        try:
            ...
            self.logger.error(f"函数执行失败: {str(e)}")
            raise
