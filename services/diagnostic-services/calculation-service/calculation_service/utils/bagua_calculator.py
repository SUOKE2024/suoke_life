...
class BaguaCalculator:
    ...
    def analyze_constitution(
        self, bazi: dict, birth_location: dict | None = None
    ) -> dict:
        """
        基于八字分析八卦体质
    ...
    def _analyze_constitution_characteristics(
        self, gua: str, gua_info: dict, wuxing: dict
    ) -> dict:
        """
        分析体质特征
        ...
        if gua == "乾":
            characteristics = ["性格刚强果断", "具有领导能力", "肺气充足", "皮肤较好"]
            disease_location = "肺系、皮肤、大肠"

        elif gua == "坤":
            characteristics = ["性格温和包容", "消化功能良好", "肌肉丰满", "适应性强"]
            disease_location = "脾胃系统"

        elif gua == "震":
            characteristics = ["性格急躁易怒", "行动力强", "筋骨强健", "反应敏捷"]
            disease_location = "肝胆系统、筋骨"

        elif gua == "巽":
            characteristics = ["性格温和渐进", "善于沟通", "肝气条达", "适应变化"]
            disease_location = "肝胆系统、神经系统"

        elif gua == "坎":
            characteristics = ["性格深沉智慧", "意志坚强", "肾气充足", "骨骼强健"]
            disease_location = "肾系、泌尿生殖系统"

        elif gua == "离":
            characteristics = ["性格热情开朗", "思维敏捷", "心火旺盛", "精神饱满"]
            disease_location = "心系、血管、神经系统"

        elif gua == "艮":
            characteristics = ["性格稳重内敛", "思考深入", "脾胃功能稳定", "耐力较好"]
    ...
    def _generate_health_advice(self, gua: str, gua_info: dict) -> list[str]:
        ...
        if gua == "乾":
            ...
            advice = ["健脾益胃", "饮食规律清淡", "避免过度思虑", "适当运动促进消化"]

        elif gua == "震":
            advice = ["疏肝理气", "调畅情志", "避免暴怒", "适度运动舒筋活血"]

        elif gua == "巽":
            advice = ["养肝血", "保持心情舒畅", "避免过度紧张", "多做柔和运动"]

        elif gua == "坎":
            advice = ["补肾益精", "避免过度房事", "注意保暖", "适当进补"]

        elif gua == "离":
            advice = ["清心降火", "养心安神", "避免过度兴奋", "保持心境平和"]

        elif gua == "艮":
            advice = ["健脾化湿", "避免久坐不动", "保持适度运动", "注意肌肉锻炼"]

        elif gua == "兑":
            advice = ["润肺止咳", "保护嗓子", "避免辛辣刺激", "多做呼吸运动"]
