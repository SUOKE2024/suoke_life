...
def test_comprehensive_api() -> None:
    """测试综合分析API"""
    print("\n === 测试综合算诊分析API === ")
...
def main() -> None:
    ...
    print("详细测试结果已保存到: api_test_results.json")
