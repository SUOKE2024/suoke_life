...
class ServiceRegistry:
        ...
        look_service = ServiceInfo(
            ...
            endpoints=[
                ServiceEndpoint(
                    service_name="look-service",
                    service_type="grpc",
                    host=services_config.get("look_service", {}).get(
                        "host", "localhost"
                    ),
            ...
            metadata={
                "version": "1.0.0",
                "capabilities": ["face_analysis", "tongue_analysis"],
            },
        )
        ...
        listen_service = ServiceInfo(
            ...
            endpoints=[
                ServiceEndpoint(
                    service_name="listen-service",
                    service_type="grpc",
                    host=services_config.get("listen_service", {}).get(
                        "host", "localhost"
                    ),
                ...
                ServiceEndpoint(
                    ...
                    port=services_config.get("listen_service", {}).get(
                        "http_port", 8002
                    ),
                    path="/api/v1/listen",
                ),
            ...
            metadata={
                "version": "1.0.0",
                "capabilities": ["voice_analysis", "breath_analysis"],
            },
        )
        ...
        inquiry_service = ServiceInfo(
            ...
            endpoints=[
                ServiceEndpoint(
                    service_name="inquiry-service",
                    service_type="grpc",
                    host=services_config.get("inquiry_service", {}).get(
                        "host", "localhost"
                    ),
                ...
                ServiceEndpoint(
                    ...
                    port=services_config.get("inquiry_service", {}).get(
                        "http_port", 8003
                    ),
                    path="/api/v1/inquiry",
                ),
            ...
            metadata={
                "version": "1.0.0",
                "capabilities": ["symptom_analysis", "history_analysis"],
            },
        )
        ...
        palpation_service = ServiceInfo(
            ...
            endpoints=[
                ServiceEndpoint(
                    service_name="palpation-service",
                    service_type="grpc",
                    host=services_config.get("palpation_service", {}).get(
                        "host", "localhost"
                    ),
                    port=services_config.get("palpation_service", {}).get(
                        "port", 50054
                    ),
                ),
                ServiceEndpoint(
            ...
            metadata={
                "version": "1.0.0",
                "capabilities": ["pulse_analysis", "pressure_analysis"],
            },
        )
        ...
        calculation_service = ServiceInfo(
            ...
            endpoints=[
                ServiceEndpoint(
                    service_name="calculation-service",
                    service_type="grpc",
                    host=services_config.get("calculation_service", {}).get(
                        "host", "localhost"
                    ),
                    port=services_config.get("calculation_service", {}).get(
                        "port", 50055
                    ),
                ),
                ServiceEndpoint(
            ...
            metadata={
                "version": "1.0.0",
                "capabilities": ["constitution_analysis", "risk_assessment"],
            },
        )
    ...
    async def _health_check_service(self, service_name: str) -> None:
        ...
        try:
            ...
            logger.debug(
                f"健康检查完成: {service_name}, 状态: {service_info.status.value}"
            )
