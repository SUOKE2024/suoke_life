...
class InvalidInputError(BaseServiceError):
    ...
    def __init__(self, message: str = "Invalid input", code: str = "INVALID_INPUT", details: dict = None):
        """TODO: 添加文档字符串"""
...
class AuthenticationError(BaseServiceError):
    ...
    def __init__(self, message: str = "Authentication failed", code: str = "AUTH_FAILED", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class AuthorizationError(BaseServiceError):
    ...
    def __init__(self, message: str = "Not authorized", code: str = "NOT_AUTHORIZED", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class ResourceExistsError(BaseServiceError):
    ...
    def __init__(self, message: str = "Resource already exists", code: str = "ALREADY_EXISTS", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class ProcessingError(BaseServiceError):
    ...
    def __init__(self, message: str = "Processing error", code: str = "PROCESSING_ERROR", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class DatabaseError(BaseServiceError):
    ...
    def __init__(self, message: str = "Database error", code: str = "DB_ERROR", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class ModelError(BaseServiceError):
    ...
    def __init__(self, message: str = "Model error", code: str = "MODEL_ERROR", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class TimeoutError(BaseServiceError):
    ...
    def __init__(self, message: str = "Request timed out", code: str = "TIMEOUT", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)
...
class ExternalServiceError(BaseServiceError):
    ...
    def __init__(self, message: str = "External service error", code: str = "EXTERNAL_ERROR", details: dict = None):
        """TODO: 添加文档字符串"""
        super().__init__(message, code, details)