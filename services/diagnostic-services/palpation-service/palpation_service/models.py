...
class SensorDataInput(BaseModel):
    ...
    class Meta:
        ...
        # 数据库表选项
        db_table = 'multimodalfusionresult'
        ordering = [' - created_at']
