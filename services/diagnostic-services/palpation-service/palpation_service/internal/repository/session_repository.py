...
class SessionRepository:
    ...
    def create_abdominal_analysis(bool):
        """
        创建腹诊分析记录
    ...
    def get_abdominal_analysis(dict[str, Any] | None):
        """
        获取腹诊分析记录
    ...
    def get_skin_analysis(dict[str, Any] | None):
        """
        获取皮肤触诊分析记录
