...
class ConfigManager:
    ...
    def _load_default_config(self):
        ...
        default_config = {
            ...
            "cache": {"enabled": True, "type": "memory", "max_size": 1000, "ttl": 3600},
            "logging": {
                "level": "INFO",
        ...
        with self.lock:
            ...
            self.config_sources = dict.fromkeys(
                self._flatten_dict(default_config).keys(), ConfigSource.FILE
            )

    def load_config_file(self, file_path: str | Path, merge: bool = True) -> bool:
        """
        加载配置文件
