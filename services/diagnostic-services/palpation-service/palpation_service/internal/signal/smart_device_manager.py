...
class SmartDeviceManager:
    ...
    async def calibrate_device(self, device_id: str, operator: str) -> SensorCalibrationData | None:
        """
        校准设备
    ...
    async def _select_best_device(self, preference: str | None = None) -> str | None:
        """选择最佳设备"""
        available_devices = []
