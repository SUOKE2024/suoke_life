...
if hasattr(config, "services") and config.services:
    ...
    def get_endpoint(self, service_name: str) -> tuple[str, int] | None:
"""
获取服务端点
...
try:
            ...
            logger.error(f"从Consul刷新服务失败: {e!s}")
...
if self.api_client is None:
            try:
                ...
                logger.error(f"初始化Kubernetes客户端失败: {e!s}")
...
try:
            ...
            logger.error(f"从Kubernetes刷新服务失败: {e!s}")
