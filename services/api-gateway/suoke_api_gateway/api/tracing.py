...
from ..services.tracing import TracingService, get_tracing_service
...
class TraceSearchRequest(BaseModel):
    ...
    tags: dict[str, Any] | None = Field(None, description = "标签过滤")
...
async def search_traces(
    service_name: str | None = Query(None, description = "服务名称"),
    operation_name: str | None = Query(None, description = "操作名称"),
