...
description = "查询参数"
    ...
    body: bytes | None = Field(default = None, description = "请求体")
...
class GatewayResponse(BaseModel):
    ...
    body: bytes | None = Field(default = None, description = "响应体")
    ...
    service_name: str | None = Field(default = None, description = "处理服务名称")
...
class RouteInfo(BaseModel):
    ...
    target_path: str | None = Field(default = None, description = "目标路径")
    auth_required: bool = Field(default = True, description = "是否需要认证")
    rate_limit: str | None = Field(default = None, description = "限流规则")
    timeout: int = Field(default = 30, description = "超时时间(秒)")
    retry_count: int = Field(default = 3, description = "重试次数")
    cache_ttl: int | None = Field(default = None, description = "缓存TTL(秒)")
...
class CircuitBreakerInfo(BaseModel):
    ...
    expected_exception: str | None = Field(default = None, description = "预期异常类型")
