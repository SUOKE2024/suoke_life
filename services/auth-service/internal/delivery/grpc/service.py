...
from internal.model.errors import (
    ...
    MFAInvalidCodeError, ValidationError
)
        ...
        try:
            ...
            async with get_session() as session:
                ...
                if request.auth_method == auth_pb2.PASSWORD:
                    ...
                    context.set_details("短信验证码登录暂未实现")
                    return auth_pb2.LoginResponse(
                        success=False,
                        message="短信验证码登录暂未实现"
                    )
                    ...
                    # TODO: 实现邮箱验证码登录
                    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
                    context.set_details("邮箱验证码登录暂未实现")
                    return auth_pb2.LoginResponse(
                        success=False,
                        message="邮箱验证码登录暂未实现"
                    )
                    ...
                    # TODO: 实现OAuth登录
                    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
                    context.set_details("OAuth登录暂未实现")
                    return auth_pb2.LoginResponse(
                        success=False,
                        message="OAuth登录暂未实现"
                    )
