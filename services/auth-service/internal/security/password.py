...
class PasswordManager:
    ...
    def hash_password(self, password: str) -> str:
        ...
        # 先验证密码策略
        if self.policy:
            enforce_password_policy(password, self.policy)
    ...
    def validate_password(self, password: str) -> Tuple[bool, Optional[str]]:
        ...
        Returns:
            (是否有效, 无效原因)
        """
        return validate_password_policy(password, self.policy)
...
class PasswordHasher:
    ...
    def enforce_password_policy(password: str) -> Tuple[bool, Optional[str]]:
        ...
        return validate_password_policy(password, default_policy)
