...
from desktop_automation import (
    DesktopAutomationService, DesktopAction, ActionType, Point, ActionResult
)
from location_service import (
    LocationService, Location, Coordinate, LocationType, NavigationMode
)
from sensor_manager import (
    SensorManager, SensorType, SensorReading, SensorConfig
)
...
class TestLocationService:
    ...
    async def test_get_current_location(self, location_service):
        ...
        assert location.location_type in [LocationType.OUTDOOR, LocationType.INDOOR, LocationType.UNKNOWN]
...
class TestSensorManager:
    ...
    async def test_start_sensor(self, sensor_manager):
        ...
        assert success is True
        assert sensor_manager.get_sensor_status(SensorType.ACCELEROMETER).value == "active"
    ...
    async def test_stop_sensor(self, sensor_manager):
        ...
        assert success is True
        assert sensor_manager.get_sensor_status(SensorType.ACCELEROMETER).value == "inactive"
