...
def setup_health_data_service_mock():
    """设置健康数据服务的模拟响应"""
    # 模拟获取健康数据API
    create_expectation(
        {
    ...
    create_expectation(
        ...
        },
        {
            ...
            "body": json.dumps({
                "success": True,
                "message": "数据提交成功",
                "data_points_accepted": 1
            })
        }
    )

def setup_agent_service_mock():
    """设置智能体服务的模拟响应"""
    # 模拟小艾智能体API
    create_expectation(
        {
