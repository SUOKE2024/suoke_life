...
class PlatformAuth(BaseDBModel):
    ...
    def refresh_access_token(self, new_token: str, expires_at: Optional[datetime] = None):
        """刷新访问令牌"""
...
class UserIntegration(BaseDBModel):
    ...
    # 认证信息
    auth_info: Optional[PlatformAuth] = None
    
    def update_last_sync(self, status: str, timestamp: Optional[datetime] = None):
        """更新最后同步信息"""
