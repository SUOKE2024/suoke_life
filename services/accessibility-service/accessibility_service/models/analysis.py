...
class ComprehensiveAnalysis(BaseAnalysis):
    ...
    visual_analysis: Optional[VisualAnalysis] = Field(None, description="Visual analysis results")
    audio_analysis: Optional[AudioAnalysis] = Field(None, description="Audio analysis results")
    motor_analysis: Optional[MotorAnalysis] = Field(None, description="Motor analysis results")
    cognitive_analysis: Optional[CognitiveAnalysis] = Field(None, description="Cognitive analysis results")
...
class AnalysisReport(BaseModel):
    ...
    previous_score: Optional[float] = Field(None, description="Previous accessibility score")
