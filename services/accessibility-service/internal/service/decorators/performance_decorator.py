    ...
    def decorator(func: Callable):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.debug(f"性能监控: {op_name} 耗时 {duration*1000:.2f}ms, 成功: {success}")
    ...
    def decorator(func: Callable):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                duration = time.time() - start_time
                if _performance_monitor:
                    _performance_monitor._collector.record_timer(name, duration * 1000, tags)
        ...
        async def async_wrapper(*args, **kwargs):
            try:
                ...
                if _performance_monitor:
                    ...
                    _performance_monitor._collector.record_counter(name, increment, success_tags)
                return result
            except Exception as e:
                if _performance_monitor:
                    ...
                    _performance_monitor._collector.record_counter(name, increment, error_tags)
                raise
