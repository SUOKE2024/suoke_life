...
class TCMAccessibilityService:
    ...
    def _load_tcm_terminology(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"加载中医术语数据失败: {str(e)}")
            return {}
    ...
    def _load_meridian_points(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"加载经络穴位数据失败: {str(e)}")
            return {}
        
    def generate_tongue_description(self, tongue_image: bytes, 
                                    simplification_level: int = 2) -> Dict[str, Any]:
        """生成舌象的无障碍描述
    ...
    def generate_face_diagnosis_description(self, face_image: bytes,
                                           simplification_level: int = 2) -> Dict[str, Any]:
        """生成面诊的无障碍描述
    ...
    def _generate_structured_description(self, features: Dict[str, Any], 
                                        diagnosis_type: str,
                                        simplification_level: int = 2) -> str:
        """生成结构化描述
        ...
        for feature_key, feature_value in features.items():
            if feature_key in diagnosis_data and feature_value in diagnosis_data[feature_key]:
                # 获取指定简化等级的描述
                level_key = str(simplification_level)
                if level_key in diagnosis_data[feature_key][feature_value]:
                    description_parts.append(diagnosis_data[feature_key][feature_value][level_key])
