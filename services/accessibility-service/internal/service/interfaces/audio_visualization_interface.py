...
class IAudioVisualizationService(ABC):
    ...
    @abstractmethod
    async def update_visualization_config(self, 
                                        user_id: str,
                                        stream_id: str,
    ...
    @abstractmethod
    async def get_frame_sequence(self, 
                               user_id: str,
                               stream_id: str,
                               start_frame: int,
    ...
    @abstractmethod
    async def stop_visualization_stream(self, 
                                      user_id: str,
                                      stream_id: str) -> Dict[str, Any]:
        """
        停止可视化流
    ...
    @abstractmethod
    async def pause_visualization_stream(self, 
                                       user_id: str,
                                       stream_id: str) -> Dict[str, Any]:
        """
        暂停可视化流
    ...
    @abstractmethod
    async def resume_visualization_stream(self, 
                                        user_id: str,
                                        stream_id: str) -> Dict[str, Any]:
        """
        恢复可视化流
    ...
    @abstractmethod
    async def get_user_streams(self, 
                             user_id: str,
    ...
    @abstractmethod
    async def detect_audio_events(self, 
                                 user_id: str,
                                 stream_id: str,
    ...
    @abstractmethod
    async def get_audio_insights(self, 
                               user_id: str,
                               stream_id: str,
    ...
    @abstractmethod
    async def create_visualization_preset(self, 
                                        user_id: str,
                                        preset_name: str,
    ...
    @abstractmethod
    async def apply_visualization_preset(self, 
                                       user_id: str,
                                       stream_id: str,
    ...
    @abstractmethod
    async def get_audio_spectrum_data(self, 
                                    user_id: str,
                                    stream_id: str,
                                    frequency_range: Dict[str, float] = None) -> Dict[str, Any]:
        """
        获取音频频谱数据
    ...
    @abstractmethod
    async def detect_music_features(self, 
                                  user_id: str,
                                  stream_id: str) -> Dict[str, Any]:
        """
        检测音乐特征
    ...
    @abstractmethod
    async def detect_speech_features(self, 
                                   user_id: str,
                                   stream_id: str) -> Dict[str, Any]:
        """
        检测语音特征
    ...
    @abstractmethod
    async def get_environmental_audio_analysis(self, 
                                             user_id: str,
                                             stream_id: str) -> Dict[str, Any]:
        """
        获取环境音频分析
    ...
    @abstractmethod
    async def create_audio_alert(self, 
                               user_id: str,
    ...
    @abstractmethod
    async def get_audio_alerts(self, 
                             user_id: str,
    ...
    @abstractmethod
    async def update_audio_alert(self, 
                               user_id: str,
                               alert_id: str,
    ...
    @abstractmethod
    async def delete_audio_alert(self, 
                               user_id: str,
    ...
    @abstractmethod
    async def optimize_visualization_performance(self, 
                                               user_id: str,
                                               stream_id: str,
