...
class IMemoryAssistanceService(ABC):
    ...
    @abstractmethod
    async def delete_reminder(self, user_id: str, reminder_id: str) -> dict[str, Any]:
        """
        删除提醒
    ...
    async def get_user_reminders(
        self, user_id: str, reminder_type: ReminderType = None, status: str = None
    ) -> dict[str, Any]:
        """
        获取用户提醒列表
    ...
    @abstractmethod
    async def perform_cognitive_assessment(
        self, user_id: str, assessment_type: str = "comprehensive"
    ) -> dict[str, Any]:
        """
        执行认知评估
    ...
    @abstractmethod
    async def get_cognitive_exercises(
        self, user_id: str, cognitive_domain: str = None, difficulty_level: int = None
    ) -> dict[str, Any]:
        """
        获取认知训练练习
    ...
    async def get_memory_insights(
        self, user_id: str, insight_type: str = "summary"
    ) -> dict[str, Any]:
        """
        获取记忆洞察
    ...
    async def get_memory_network(
        self, user_id: str, memory_id: str = None, depth: int = 2
    ) -> dict[str, Any]:
        """
        获取记忆网络
    ...
    @abstractmethod
    async def optimize_reminder_schedule(
        self, user_id: str, optimization_criteria: dict[str, Any] = None
    ) -> dict[str, Any]:
        """
        优化提醒调度
    ...
    async def get_cognitive_trends(
        self, user_id: str, time_range: dict[str, str] = None, metrics: list[str] = None
    ) -> dict[str, Any]:
        """
        获取认知趋势
    ...
    @abstractmethod
    async def update_care_plan_progress(
        self, user_id: str, plan_id: str, progress_data: dict[str, Any]
    ) -> dict[str, Any]:
        """
        更新护理计划进度
    ...
    async def trigger_emergency_alert(
        self, user_id: str, alert_type: str, context: dict[str, Any] = None
    ) -> dict[str, Any]:
        """
        触发紧急警报
