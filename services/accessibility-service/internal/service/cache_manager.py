...
class CacheManager:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self._memory_max_size = (
            cache_config.get("memory_max_size_mb", 256) * 1024 * 1024
        )
        ...
        self._disk_cache_dir = cache_config.get(
    ...
    async def _init_redis(self):
        ...
        try:
            ...
            logger.warning(f"Redis缓存初始化失败: {e!s}, 禁用Redis缓存")
    ...
    async def _init_disk_cache(self):
        ...
        try:
            ...
            logger.warning(f"磁盘缓存初始化失败: {e!s}, 禁用磁盘缓存")
    ...
    async def _get_from_redis(self, key: str) -> Any | None:
        ...
        try:
            ...
            logger.error(f"Redis获取失败: {key}, 错误: {e!s}")
            return None
    ...
    async def _set_to_redis(self, key: str, value: Any, ttl: int) -> bool:
        ...
        try:
            ...
            logger.error(f"Redis设置失败: {key}, 错误: {e!s}")
            return False
    ...
    async def _delete_from_redis(self, key: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Redis删除失败: {key}, 错误: {e!s}")
            return False
    ...
    async def _get_from_disk(self, key: str) -> Any | None:
        ...
        try:
            ...
            logger.error(f"磁盘缓存获取失败: {key}, 错误: {e!s}")
            return None
    ...
    async def _set_to_disk(self, key: str, value: Any, ttl: int) -> bool:
        ...
        try:
            ...
            await loop.run_in_executor(
                None, lambda: self._write_disk_cache(file_path, value)
            )

            return True

        except Exception as e:
            logger.error(f"磁盘缓存设置失败: {key}, 错误: {e!s}")
            return False
    ...
    async def _delete_from_disk(self, key: str) -> bool:
        ...
        try:
            ...
            logger.error(f"磁盘缓存删除失败: {key}, 错误: {e!s}")
            return False
