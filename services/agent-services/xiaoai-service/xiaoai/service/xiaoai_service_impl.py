...
class XiaoaiServiceImpl:
    ...
    async def comprehensive_diagnosis(self, diagnosis_request: dict[str, Any], user_id: str) -> dict[str, Any]:
        """综合诊断"""
    ...
    async def query_medical_records(self, query_request: dict[str, Any], user_id: str) -> dict[str, Any]:
        """查询医疗记录"""
        return {
            "user_id": user_id,
            "records": [
    ...
    async def process_text_input(self, text_content: str, user_id: str) -> dict[str, Any]:
        """处理文本输入"""
    ...
    async def generate_health_report(self, report_request: dict[str, Any], user_id: str) -> dict[str, Any]:
        """生成健康报告"""
        return {
