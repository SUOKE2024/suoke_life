...
class DeepSeekModelFactory:
    ...
    def __init__(self):
        ...
        self.apibase = self.deepseek_config.get('api_base', 'https://api.deepseek.com/v1')
    ...
    async def _test_connection(self):
        ...
        try:
            ...
            if response and response.choices:
                ...
                raise Exception("API响应格式异常") from None
    ...
    async def generate_text(self, model: str, prompt: str, **kwargs) -> tuple[str, dict[str, Any]]:
        ...
        if not self.client:
            raise Exception("DeepSeek客户端未初始化") from None
    ...
    async def generate_chat_completion(self, model: str, messages: list[dict[str, str]],
                                      temperature: float = 0.7, maxtokens: int = 2048,
