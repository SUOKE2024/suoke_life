...
class TestXiaoaiserviceService:
    """全面的xiaoai-service服务测试"""
    ...
    def test_configuration_loading(self, mock_config):
        """测试配置加载"""
        assert mock_config["service_name"] == "xiaoai-service"
...
class TestXiaoaiserviceDatabase:
    """数据库操作测试"""
