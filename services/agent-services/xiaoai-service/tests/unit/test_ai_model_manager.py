...
class TestAIModelManager:
    ...
    async def test_batch_predict(self, model_manager):
        ...
        mock_instance.predict.side_effect = [["result1", "result2"], ["result3"]]
    ...
    async def test_unload_all_models(self, model_manager):
        ...
        model_manager.models = {"model1": mock_instance1, "model2": mock_instance2}
    ...
    def test_get_all_metrics(self, model_manager):
        ...
        assert result == {"model1": mock_metrics1, "model2": mock_metrics2}
