...
from internal.four_diagnosis.reasoning.syndrome_differentiation import SyndromeDifferentiationEngine
...
class TestFourDiagnosisIntegration(unittest.TestCase):
    ...
    def _load_test_data(self, filename):
        ...
        try:
            ...
            logger.warning(f"加载测试数据文件 {filename} 失败: {str(e)}")
            return None
