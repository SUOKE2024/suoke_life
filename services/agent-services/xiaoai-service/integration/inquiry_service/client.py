...
class InquiryServiceClient:
    ...
    async def analyze_conversation(self,
                                  ...
                                  metadata: dict[str, str] | None = None) -> inquiry_pb.ConversationAnalysisResponse:
        """
        分析问诊对话
    ...
    async def analyze_symptoms(self,
                              ...
                              user_id: str,
                              save_result: bool = True,
                              metadata: dict[str, str] | None = None) -> inquiry_pb.SymptomAnalysisResponse:
        """
        分析症状
    ...
    async def analyze_medical_history(self,
                                     ...
                                     user_id: str,
                                     save_result: bool = True,
                                     metadata: dict[str, str] | None = None) -> inquiry_pb.MedicalHistoryAnalysisResponse:
        """
        分析病史
    ...
    async def generate_inquiry_questions(self,
                                        ...
                                        metadata: dict[str, str] | None = None) -> inquiry_pb.InquiryQuestionsResponse:
        """
        生成问诊问题
