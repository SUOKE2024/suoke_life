...
class PalpationServiceClient:
    ...
    async def analyze_pulse(self, 
                           ...
                           metadata: Optional[Dict[str, str]] = None) -> palpation_pb.PulseAnalysisResponse:
        """
        分析脉象
    ...
    async def analyze_abdominal_palpation(self, 
                                        ...
                                        save_result: bool = True,
                                        metadata: Optional[Dict[str, str]] = None) -> palpation_pb.AbdominalAnalysisResponse:
        """
        分析腹诊
        ...
        try:
            ...
            raise RuntimeError(f"腹诊分析失败: {e}")
            
    async def analyze_skin_touch(self, 
                               touch_data: Dict[str, Any], 
                               user_id: str,
                               save_result: bool = True,
                               metadata: Optional[Dict[str, str]] = None) -> palpation_pb.SkinTouchAnalysisResponse:
        """
        分析皮肤触感
        ...
        try:
            ...
            logger.error(f"皮肤触感分析失败: {e}")
            raise RuntimeError(f"皮肤触感分析失败: {e}")
            
    async def analyze_acupoint(self, 
                              acupoint_data: Dict[str, Any], 
                              user_id: str,
                              save_result: bool = True,
                              metadata: Optional[Dict[str, str]] = None) -> palpation_pb.AcupointAnalysisResponse:
        """
        分析穴位反应
        ...
        try:
            ...
            logger.error(f"穴位反应分析失败: {e}")
            raise RuntimeError(f"穴位反应分析失败: {e}")
    ...
    async def get_analysis_history(self, 
                                  ...
                                  end_time: Optional[int] = None) -> palpation_pb.AnalysisHistoryResponse:
        """
        获取分析历史
