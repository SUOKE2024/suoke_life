...
class LookServiceClient:
    ...
    async def analyze_tongue(self,
                             ...
                             metadata: dict[str, str] | None = None) -> look_pb.TongueAnalysisResponse:
        """
        分析舌象
    ...
    async def analyze_face(self,
                           ...
                           user_id: str,
                           save_result: bool = True,
                           metadata: dict[str, str] | None = None) -> look_pb.FaceAnalysisResponse:
        """
        分析面色
    ...
    async def analyze_body(self,
                           ...
                           user_id: str,
                           save_result: bool = True,
                           metadata: dict[str, str] | None = None) -> look_pb.BodyAnalysisResponse:
        """
        分析形体
