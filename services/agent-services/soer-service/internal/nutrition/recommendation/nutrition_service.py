...
class NutritionService:
    ...
    async def generate_diet_recommendations(self, user_id: str, constitution_type: str,
        ...
        # 获取用户健康画像
        await self.repos.health_profile_repo.get_by_user_id(user_id)
    ...
    async def get_recipe_by_constitution(self, constitution_type: str, season: str | None = None) -> list[dict[str, Any]]:
        """获取适合特定体质的食谱
    ...
    async def _generate_meal_plans(self, user_id: str, constitution_type: str, season: str,
        ...
        """
        # 获取体质食谱
        await self.repos.nutrition_repo.get_recipes_for_constitution(constitution_type, season)
    ...
    async def _get_recommended_nutrition(self, user_id: str) -> dict[str, dict[str, float]]:
        ...
        """
        # 获取用户信息
        await self.repos.user_repo.get_user_info(user_id)
    ...
    def _generate_improvement_suggestions(self, nutrition_balance: dict[str, Any],
                                      ...
                                      constitution_type: str | None) -> list[dict[str, Any]]:
        """生成改进建议
