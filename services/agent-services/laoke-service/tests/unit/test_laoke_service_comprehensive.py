...
class TestLaokeserviceService:
    """全面的laoke-service服务测试"""
    ...
    def test_configuration_loading(self, mock_config):
        """测试配置加载"""
        assert mock_config["service_name"] == "laoke-service"
...
class TestLaokeserviceDatabase:
    """数据库操作测试"""
