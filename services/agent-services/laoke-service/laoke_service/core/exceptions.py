...
class SessionException(LaokeServiceException):
    ...
    def __init__(self, message: str, session_id: Optional[str] = None, error_type: str = "general"):
        error_code_map = {
...
class UserServiceException(LaokeServiceException):
    ...
    def __init__(self, message: str, user_id: Optional[str] = None, cause: Optional[Exception] = None):
...
class AccessibilityServiceException(LaokeServiceException):
    ...
    def __init__(self, message: str, conversion_type: Optional[str] = None, cause: Optional[Exception] = None):
...
class ContentException(LaokeServiceException):
    ...
    def __init__(self, message: str, content_type: Optional[str] = None, error_type: str = "general"):
        error_code_map = {
...
class EducationServiceException(LaokeServiceException):
    ...
    def __init__(self, message: str, resource_id: Optional[str] = None, error_type: str = "general"):
        error_code_map = {
...
def handle_exception(exc: Exception) -> LaokeServiceException:
    ...
    if "database" in exc_str or "sql" in exc_str or "connection" in exc_type:
        ...
        return AIModelException(f"Operation timeout: {exc}", error_type="timeout", cause=exc)
