...
from .exceptions import LaoKeServiceError, AIServiceError, KnowledgeBaseError
...
class LaoKeAgent:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise LaoKeServiceError(f"智能体初始化失败: {e}")
    ...
    async def _handle_knowledge_query(
        ...
        try:
            ...
            raise KnowledgeBaseError(f"知识查询失败: {e}")
    ...
    async def _handle_learning_plan(
        ...
        try:
            ...
            raise LaoKeServiceError(f"学习规划失败: {e}")
    ...
    async def _handle_community_interaction(
        ...
        try:
            ...
            raise LaoKeServiceError(f"社区互动失败: {e}")
    ...
    async def _handle_general_chat(
        ...
        try:
            ...
            response_text = f"您好！我是老克，您的中医知识学习助手。"
            ...
            raise AIServiceError(f"对话处理失败: {e}")
