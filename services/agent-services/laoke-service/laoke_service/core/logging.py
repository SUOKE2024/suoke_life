...
class LoggerManager:
    ...
    def log_ai_interaction(self, model: str, prompt_tokens: int, completion_tokens: int, 
    ...
    def log_database_operation(self, operation: str, table: str, duration_ms: float, 
                              affected_rows: Optional[int] = None,**kwargs) -> None:
        """记录数据库操作日志"""
        context = {
...
def log_request(method: str, path: str, user_id: Optional[str] = None,**kwargs) -> None:
    """记录请求日志"""
...
def log_ai_interaction(model: str, prompt_tokens: int, completion_tokens: int, 
                      duration_ms: float,**kwargs) -> None:
    """记录AI交互日志"""
    logger_manager.log_ai_interaction(model, prompt_tokens, completion_tokens, duration_ms,**kwargs)


def log_database_operation(operation: str, table: str, duration_ms: float, 
                          affected_rows: Optional[int] = None,**kwargs) -> None:
    """记录数据库操作日志"""
    logger_manager.log_database_operation(operation, table, duration_ms, affected_rows,**kwargs)


def log_cache_operation(operation: str, key: str, hit: Optional[bool] = None, 
                       duration_ms: Optional[float] = None,**kwargs) -> None:
    """记录缓存操作日志"""
...
def log_business_event(event_type: str, user_id: Optional[str] = None,**kwargs) -> None:
    """记录业务事件日志"""
