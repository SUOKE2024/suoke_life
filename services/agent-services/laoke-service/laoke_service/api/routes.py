...
@app.get("/sessions/{session_id}", response_model=SessionResponse, summary="获取会话信息")
...
@app.post("/sessions/{session_id}/chat", response_model=ChatResponse, summary="对话接口")
async def chat(
    session_id: str,
    request: ChatRequest
):
...
@app.get("/sessions/{session_id}/history", response_model=HistoryResponse, summary="获取对话历史")
