...
class AgentManager:
    ...
    async def _generate_treatment_plan(self, user_id: str, request_data: Dict[str, Any], 
...
"""
    ...
    async def _provide_medicine_info(self, user_id: str, request_data: Dict[str, Any], 
                                   session_id: str) -> Dict[str, Any]:
        """提供药品信息"""
        # 提取药品名称或其他查询信息
...
"""
    ...
    async def _allocate_medical_resource(self, user_id: str, request_data: Dict[str, Any], 
                                       session_id: str) -> Dict[str, Any]:
        """医疗资源调度"""
        # 提取资源需求信息
...
"""
    ...
    async def _handle_emergency(self, user_id: str, request_data: Dict[str, Any], 
                              session_id: str) -> Dict[str, Any]:
        """处理医疗紧急情况"""
        # 提取紧急情况信息
