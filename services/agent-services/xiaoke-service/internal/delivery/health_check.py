    ...
    def _check_dependencies(self):
        ...
        if not all_ok:
            ...
            for service, info in self.service_status.dependencies.items():
                if service not in critical_services and info["status"] != HealthStatus.OK:
    ...
    def _check_postgres(self):
        ...
        try:
            ...
            if result and result[0] == 1:
                ...
                return HealthStatus.DOWN, {"status": HealthStatus.DOWN, "error": "无效的查询结果"}
    ...
    def _check_redis(self):
        ...
        try:
            ...
            if result:
                ...
                return HealthStatus.DOWN, {"status": HealthStatus.DOWN, "error": "PING命令失败"}
