    ...
    def manage_subscription(
        ...
        # 如果是更新操作
            ...
            if billing_cycle:
                ...
                subscription['next_billing_date'] = end_date.strftime('%Y-%m-%dT%H:%M:%S')
    ...
    def _get_plan_info(self, plan_id: str) -> Dict[str, Any]:
        ...
        plans = {
            ...
            "premium": {
                ...
                'name': "健康优享会员",
                'price': 99.9,
                'included_services': ["高级健康咨询", "全套四诊分析", "个性化食谱", "季节性养生方案"]
            },
            "family": {
                'id': "family",
                'name': "家庭健康套餐",
                'price': 199.9,
                'included_services': ["家庭成员体质分析", "家庭共享健康方案", "定制家庭食谱", "农场认养服务"]
            }
        }
