...
class TestXiaokeserviceService:
    """全面的xiaoke-service服务测试"""
    ...
    def test_configuration_loading(self, mock_config):
        """测试配置加载"""
        assert mock_config["service_name"] == "xiaoke-service"
...
class TestXiaokeserviceDatabase:
    """数据库操作测试"""
