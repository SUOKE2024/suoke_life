            ...
            "customized_products": [
                {
                    "id": "prod_001",
                    "name": "温补养生茶",
                    "suitable_for": constitution_type,
                },
                {
                    "id": "prod_002",
                    "name": "有机红枣",
...
class SubscriptionRepository:
    ...
    def manage_subscription(self, **kwargs):
        ...
        if action == "create":
            ...
            return {
                "subscriptions": [
                    {"id": "sub_001", "type": "月度配送", "status": "active"}
                ]
            }
...
class XiaoKeA2AAgent(A2AServer):
    ...
    async def schedule_medical_resources(
        self,
        user_id: str,
        resource_type: str,
    ...
    async def trace_product(
        ...
        try:
            result = self.product_manager.trace_product(
                product_id=product_id, batch_id=batch_id, trace_token=trace_token
            )
            return {"success": True, "data": result}
        except Exception as e:
    ...
    async def manage_subscription(
        self, user_id: str, action: str, subscription_type: str = "", plan_id: str = ""
    ) -> Dict[str, Any]:
        """
        订阅管理技能
    ...
    async def handle_task(self, task):
        ...
        try:
            ...
            task.status = TaskStatus(
                ...
                message={
                    "role": "agent",
                    "content": {"type": "text", "text": f"处理失败: {str(e)}"},
                },
            )
    ...
    def _extract_customization_info(self, text: str) -> Dict[str, Any]:
        """从文本中提取定制信息"""
        return {"constitution": "", "conditions": [], "preferences": text.split()}
    ...
    def _extract_subscription_info(self, text: str) -> Dict[str, Any]:
        ...
        return {"action": action, "type": "", "plan_id": ""}
