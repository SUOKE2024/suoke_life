...
from ..unified_health_data_service.health_data_service.core.database import (
    DatabaseService,
)
...
async def insert_postgresql(
    ...
    try:
        result_id = await service.store_data(
            table=insert_request.table, data=insert_request.data
        )

        return APIResponse(success=True, message="插入成功", data={"id": result_id})
...
async def update_postgresql(
    ...
    try:
        ...
        return APIResponse(
            success=True, message="更新成功", data={"affected_rows": affected_rows}
        )
...
async def delete_postgresql(
    ...
    try:
        affected_rows = await service.delete_data(
            table=delete_request.table, conditions=delete_request.conditions
        )

        return APIResponse(
            success=True, message="删除成功", data={"affected_rows": affected_rows}
        )
...
async def query_mongodb(
    query_request: MongoQuery, service: DatabaseService = Depends(get_database_service)
) -> APIResponse:
    """查询MongoDB数据"""
    try:
...
async def insert_mongodb(
    ...
    try:
        result_id = await service.mongo_insert(
            collection=insert_request.collection, document=insert_request.document
        )

        return APIResponse(
            success=True, message="插入成功", data={"id": str(result_id)}
        )
...
async def update_mongodb(
    ...
    try:
        result = await service.mongo_update(
            collection=collection, filter_dict=filter_dict, update_dict=update_dict
        )
...
async def delete_mongodb(
    ...
    try:
        result = await service.mongo_delete(
            collection=collection, filter_dict=filter_dict
        )
...
async def get_cache(
    ...
    try:
        ...
        return APIResponse(
            success=True, message="获取成功", data={"key": key, "value": value}
        )
...
async def set_cache(
    ...
    try:
        ...
        return APIResponse(
            success=True, message="设置成功", data={"key": cache_request.key}
        )
...
async def delete_cache(
    ...
    try:
        ...
        return APIResponse(success=True, message="删除成功", data={"key": key})
...
async def get_database_status(
    ...
    try:
        ...
        return APIResponse(success=True, message="状态获取成功", data=status)
...
async def database_health_check(
    ...
    try:
        ...
        return APIResponse(success=True, message="健康检查完成", data=health_status)
...
async def get_database_metrics(
    ...
    try:
        ...
        return APIResponse(success=True, message="指标获取成功", data=metrics)
...
async def run_migration(
    ...
    try:
        ...
        return APIResponse(success=True, message="迁移运行成功", data=result)
...
async def get_migration_status(
    ...
    try:
        ...
        return APIResponse(success=True, message="迁移状态获取成功", data=status)
