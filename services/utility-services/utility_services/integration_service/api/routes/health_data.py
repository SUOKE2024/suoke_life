...
@router.get(" / {data_id}", response_model = HealthDataResponse, summary = "获取健康数据详情")
...
async def sync_health_data(
    ...
    try:
        ...
        logger.info(f"用户 {current_user.username} 从平台 {sync_request.platform_id} 同步健康数据")
...
@router.get(" / stats / summary", response_model = HealthDataStatsResponse, summary = "获取健康数据统计")
