...
class BlockchainServicer(blockchain_pb2_grpc.BlockchainServiceServicer):
    ...
    async def StoreHealthData(self,
        ...
        try:
            ...
            self.logger.error(f"存储健康数据异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
            return blockchain_pb2.StoreHealthDataResponse(
                success=False,
                message=f"服务内部错误: {e!s}"
            )
    ...
    async def VerifyHealthData(self,
        ...
        try:
            ...
            self.logger.error(f"验证健康数据异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
    ...
    async def VerifyWithZKP(self,
        ...
        try:
            ...
            self.logger.error(f"零知识证明验证异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
    ...
    async def GetHealthDataRecords(self,
        ...
        try:
            ...
            self.logger.error(f"获取健康数据记录异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
    ...
    async def AuthorizeAccess(self,
        ...
        try:
            ...
            self.logger.error(f"授权访问异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
    ...
    async def RevokeAccess(self,
        ...
        try:
            ...
            self.logger.error(f"撤销访问异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
    ...
    async def GetBlockchainStatus(self,
        ...
        try:
            ...
            self.logger.error(f"获取区块链状态异常: {e!s}", exc_info=True)
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(f"服务内部错误: {e!s}")
