...
class ContractFactory:
    ...
    def _load_contract_artifacts(self):
        ...
        try:
            ...
            self.logger.error(f"加载智能合约构件失败: {e!s}")
            raise
    ...
    async def deploy_contract(
        ...
        try:
            ...
            self.logger.error(f"部署合约 {contract_name} 失败: {e!s}")
            raise
    ...
    async def upgrade_contract(
        ...
        try:
            ...
            self.logger.error(f"升级合约失败: {e!s}")
            raise
    ...
    async def verify_contract_bytecode(self, contract_name: str, deployed_address: str) -> tuple[bool, str]:
        ...
        try:
            ...
            self.logger.error(f"验证合约字节码失败: {e!s}")
    ...
    async def deploy_contract_suite(self) -> dict[str, str]:
        ...
        try:
            ...
            self.logger.error(f"部署合约套件失败: {e!s}")
            raise
