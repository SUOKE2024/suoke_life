...
class IntegratedOptimizationService:
    ...
    def __init__(
        ...
        self.current_profile: OptimizationProfile | None = None
    ...
    async def start_optimization(
        ...
        custom_profile: OptimizationProfile | None = None
    ):
        """
        启动优化服务
        ...
        try:
            ...
            await self._notify_status_change()
            self.logger.error(f"优化服务启动失败: {e!s}")
            raise
    ...
    async def stop_optimization(self):
        ...
        try:
            ...
            self.status = ServiceStatus.ERROR
            await self._notify_status_change()
            self.logger.error(f"优化服务停止失败: {e!s}")
            raise
    ...
    async def _notify_status_change(self):
        ...
        for callback in self.status_callbacks:
            try:
                ...
                self.logger.error(f"状态回调执行失败: {e!s}")
