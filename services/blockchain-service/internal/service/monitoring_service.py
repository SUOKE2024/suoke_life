...
class MonitoringService:
    ...
    async def _health_check_loop(self):
        ...
        while self.is_running:
            try:
                ...
                self.logger.error(f"健康检查循环错误: {e!s}")
    ...
    async def _run_all_health_checks(self):
        ...
        for component, checker in self.health_checkers.items():
            try:
                ...
                self.logger.error(f"健康检查失败 {component}: {e!s}")
    ...
    async def _system_metrics_loop(self):
        ...
        while self.is_running:
            try:
                ...
                self.logger.error(f"系统指标收集错误: {e!s}")
                await asyncio.sleep(5)
    ...
    async def _collect_system_metrics(self):
        ...
        try:
            ...
            self.logger.error(f"收集系统指标失败: {e!s}")
    ...
    async def _metrics_cleanup_loop(self):
        ...
        while self.is_running:
            try:
                ...
                self.logger.error(f"指标清理错误: {e!s}")
