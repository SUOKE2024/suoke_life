...
class TransactionRequest(BaseModel):
    ...
    chain: str | None = Field(None, description="目标链：ethereum, bsc, polygon, private等")
...
class ContractDeployRequest(BaseModel):
    ...
    constructor_args: list[Any] | None = Field(None, description="构造函数参数")
    chain: str | None = Field(None, description="目标链")
...
async def get_metrics():
    ...
    try:
        ...
        # 计数器指标
        metrics.append("# HELP blockchain_total_transactions Total number of transactions")
        metrics.append("# TYPE blockchain_total_transactions counter")
        metrics.append(f'blockchain_total_transactions {stats["total_transactions"]}')

        metrics.append("# HELP blockchain_batch_transactions Total number of batch transactions")
        metrics.append("# TYPE blockchain_batch_transactions counter")
        metrics.append(f'blockchain_batch_transactions {stats["batch_transactions"]}')

        metrics.append("# HELP blockchain_failed_transactions Total number of failed transactions")
        metrics.append("# TYPE blockchain_failed_transactions counter")
        metrics.append(f'blockchain_failed_transactions {stats["failed_transactions"]}')

        metrics.append("# HELP blockchain_cache_hits Total number of cache hits")
        metrics.append("# TYPE blockchain_cache_hits counter")
        metrics.append(f'blockchain_cache_hits {stats["cache_hits"]}')

        metrics.append("# HELP blockchain_cache_misses Total number of cache misses")
        metrics.append("# TYPE blockchain_cache_misses counter")
        metrics.append(f'blockchain_cache_misses {stats["cache_misses"]}')

        metrics.append("# HELP blockchain_indexed_records Total number of indexed records")
        metrics.append("# TYPE blockchain_indexed_records counter")
        metrics.append(f'blockchain_indexed_records {stats["indexed_records"]}')

        # 仪表盘指标
        metrics.append("# HELP blockchain_average_gas_price Average gas price")
        metrics.append("# TYPE blockchain_average_gas_price gauge")
        metrics.append(f'blockchain_average_gas_price {stats["average_gas_price"]}')

        metrics.append("# HELP blockchain_average_confirmation_time Average confirmation time in seconds")
        metrics.append("# TYPE blockchain_average_confirmation_time gauge")
        metrics.append(f'blockchain_average_confirmation_time {stats["average_confirmation_time"]}')

        # 活跃链数量
        metrics.append("# HELP blockchain_active_chains Number of active blockchain connections")
        metrics.append("# TYPE blockchain_active_chains gauge")
