...
class TestBlockchainserviceService:
    """全面的blockchain-service服务测试"""
    ...
    def test_configuration_loading(self, mock_config):
        """测试配置加载"""
        assert mock_config["service_name"] == "blockchain-service"
...
class TestBlockchainserviceAPI:
    """API接口测试"""
...
class TestBlockchainserviceDatabase:
    """数据库操作测试"""
