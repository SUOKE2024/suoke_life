...
class TestHybridRetriever(unittest.TestCase):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_with_cache_miss(self):
        """测试缓存未命中情况下的检索"""
        # 设置缓存未命中
    ...
    @pytest.mark.asyncio
    async def test_retrieve_with_custom_topk(self):
        """测试自定义top_k参数的检索"""
        # 设置缓存未命中
        self.mock_cache_service.get.return_value = None
    ...
    @pytest.mark.asyncio
    async def test_retrieve_with_collection_names(self):
        """测试指定集合名称的检索"""
        # 设置缓存未命中
        self.mock_cache_service.get.return_value = None
    ...
    @pytest.mark.asyncio
    async def test_retrieve_with_score_threshold(self):
        """测试结果分数阈值过滤"""
        # 设置缓存未命中
        self.mock_cache_service.get.return_value = None
    ...
    @pytest.mark.asyncio
    async def test_hybrid_retrieval_strategy(self):
        """测试混合检索策略"""
        # 设置缓存未命中
        self.mock_cache_service.get.return_value = None
