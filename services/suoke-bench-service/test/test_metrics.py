    ...
    def setUp(self):
        ...
        self.dialogue_turns = [
            ...
            DialogueTurn(
                ...
                intent="information",
                entities=[
                    {"type": "symptom", "value": "poor_sleep", "confidence": 0.9}
                ],
                confidence=0.88,
                response_time=150.0,
...
class TestPrivacyMetrics(unittest.TestCase):
    ...
    def test_privacy_verification_metric(self):
        ...
        result = metric.calculate(
            self.privacy_cases, self.privacy_results, self.zkp_cases, self.zkp_results
        )
...
class TestEdgeMetrics(unittest.TestCase):
    ...
    def test_edge_performance_metric(self):
        ...
        result = metric.calculate(
            self.device_info, self.model_info, self.perf_metrics, self.infer_metrics
        )
