...
async def readiness_check(
    ...
    try:
        ...
        try:
            ...
            checks["database"] = {"status": "not_ready", "message": f"数据库连接失败: {e!s}"}
            overall_ready = False
        ...
        try:
            ...
            checks["cache"] = {"status": "not_ready", "message": f"缓存服务失败: {e!s}"}
            overall_ready = False
        ...
        return JSONResponse(
            ...
            content={"ready": overall_ready, "checks": checks, "timestamp": time.time()},
        )

    except Exception as e:
        logger.error(f"就绪检查失败: {e}")
        return JSONResponse(
            status_code=503, content={"ready": False, "error": str(e), "timestamp": time.time()}
        )
...
async def liveness_check():
    ...
    try:
        ...
        return JSONResponse(
            status_code=503, content={"alive": False, "error": str(e), "timestamp": time.time()}
        )
    ...
    try:
        ...
        try:
            ...
            health_data["components"]["database"] = {
                ...
                "metrics": {"node_count": node_count, "relationship_count": relationship_count},
            }
        except Exception as e:
        ...
        try:
            ...
            health_data["components"]["system"] = {"status": "healthy", "metrics": system_metrics}
        except Exception as e:
            health_data["components"]["system"] = {"status": "unhealthy", "error": str(e)}
        ...
        return JSONResponse(
            status_code=503,
            content={"overall_status": "unhealthy", "error": str(e), "timestamp": time.time()},
        )
...
async def health_metrics(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"获取健康指标失败: {e!s}")
