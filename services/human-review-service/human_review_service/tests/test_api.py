...
from ..core.models import ReviewerCreate, ReviewTaskCreate, ReviewType, ReviewPriority
...
class TestReviewerAPI:
    ...
    async def test_update_reviewer(self, client):
        ...
        update_response = client.put(f"/api/v1/reviewers/{reviewer_id}", json=update_data)
