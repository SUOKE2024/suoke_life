...
class CommunicationService:
    ...
    async def start(self) -> None:
        ...
        # 启动子服务
        await asyncio.gather(self.message_bus_service.start(), self.rag_service.start())
    ...
    async def stop(self) -> None:
        ...
        # 停止子服务
        await asyncio.gather(self.message_bus_service.stop(), self.rag_service.stop())
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "components": {
                "message_bus": {
                    "status": (
                        "running" if self.message_bus_service.running else "stopped"
                    )
                },
                "rag_service": {
