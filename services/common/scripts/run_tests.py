...
class TestRunner:
    ...
    async def run_load_balancer_tests(self):
        ...
        try:
            from services.common.examples.integration_test_example import test_load_balancer
    ...
    async def run_health_checker_tests(self):
        ...
        try:
            from services.common.examples.integration_test_example import test_health_checker
    ...
    async def run_health_monitor_tests(self):
        ...
        try:
            from services.common.examples.integration_test_example import test_health_monitor
    ...
    async def run_health_aggregator_tests(self):
        ...
        try:
            from services.common.examples.integration_test_example import test_health_aggregator
    ...
    async def run_integration_tests(self):
        ...
        try:
            from services.common.examples.integration_test_example import test_integrated_scenario
    ...
    def print_test_summary(self):
        ...
        for test_name, result in self.test_results.items():
            ...
            print(f"{status_icon} {test_name:20} | {result['status']:6} | {result['duration']:6.2f}s | {result['message']}")
...
async def main():
    ...
    parser.add_argument(
        '--test', 
        choices=['all', 'load_balancer', 'health_checker', 'health_monitor', 'health_aggregator', 'integration'],
        default='all',
        help='选择要运行的测试类型'
    )
    parser.add_argument(
