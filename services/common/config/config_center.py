...
class ConfigCenter:
    ...
    def get_config(self, key: str, default: Any = None, config_type: type = None) -> Any:
        """获取配置值"""
    ...
    def set_config(self, key: str, value: Any, description: str = "", 
                   tags: List[str] = None, config_format: ConfigFormat = None) -> bool:
        """设置配置值"""
        full_key = f"{self.config_prefix}/{key}"
    ...
    def list_configs(self, prefix: str = "") -> List[ConfigItem]:
        """列出配置"""
        search_prefix = f"{self.config_prefix}/{prefix}" if prefix else self.config_prefix
    ...
    def export_to_file(self, output_file: str, prefix: str = "", 
    ...
    def _upload_config_dict(self, config_data: Dict, prefix: str, 
                           config_format: ConfigFormat, parent_key: str = ""):
        """递归上传配置字典"""
...
class ServiceConfig:
    ...
    def get(self, key: str, default: Any = None, config_type: type = None) -> Any:
        """获取服务配置"""
        full_key = f"{self.config_prefix}/{key}"
        return self.config_center.get_config(full_key, default, config_type)
    
    def set(self, key: str, value: Any, description: str = "", tags: List[str] = None):
        """设置服务配置"""
        full_key = f"{self.config_prefix}/{key}"
    ...
    def export_to_file(self, output_file: str, config_format: ConfigFormat = ConfigFormat.YAML):
        """导出服务配置到文件"""
        return self.config_center.export_to_file(output_file, self.config_prefix, config_format)

# 全局配置中心实例
_config_center = None

def get_config_center(consul_host: str = "localhost", consul_port: int = 8500,
                     environment: str = "development") -> ConfigCenter:
    """获取配置中心单例"""
...
if __name__ == "__main__":
    ...
    config_center.set_config("database/config", {
        "max_connections": 100,
        "timeout": 30
    }, "数据库连接配置")
