...
class OpenAPIGenerator:
    ...
    def add_bearer_auth(self, name: str = "bearerAuth", description: str = "JWT Bearer Token"):
        """添加Bearer认证"""
    ...
    def from_function(
        ...
        # 添加默认响应
        endpoint.add_response(APIResponse(
            status_code=200,
            description="成功响应"
        ))
    ...
    def create_health_check_schema(self) -> APISchema:
        ...
        schema.add_property("timestamp", "string", "检查时间", True, "2024-12-01T10:00:00Z")
    ...
    def create_health_metric_schema(self) -> APISchema:
        ...
        schema.add_property("timestamp", "string", "测量时间", True, "2024-12-01T10:00:00Z")
...
def get_openapi_generator(name: str) -> Optional[OpenAPIGenerator]:
    """获取OpenAPI生成器"""
