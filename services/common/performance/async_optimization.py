...
import asyncio
from typing import List, Any, Callable, TypeVar, Dict, Optional, Coroutine
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        if self.redis_pool:
            try:
                ...
                health['pools']['redis'] = f'unhealthy: {str(e)}'
        ...
        if self.pg_pool:
            try:
                ...
                health['pools']['postgres'] = f'unhealthy: {str(e)}'
                health['status'] = 'unhealthy'
        ...
        if self.mysql_pool:
            try:
                ...
                health['pools']['mysql'] = f'unhealthy: {str(e)}'
                health['status'] = 'unhealthy'
        ...
        if self.mongo_client:
            try:
                ...
                health['pools']['mongodb'] = f'unhealthy: {str(e)}'
                health['status'] = 'unhealthy'
