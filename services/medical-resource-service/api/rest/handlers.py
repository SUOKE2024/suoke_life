...
from ...internal.infrastructure.container import (
    get_xiaoke_agent, get_tcm_service, get_food_service, 
    get_wellness_service, get_scheduler_service, get_database_manager,
    ...
    try:
        ...
        if request.constitution:
            try:
                ...
                raise HTTPException(status_code=400, detail=f"无效的体质类型: {request.constitution}")
...
async def recommend_treatment(request: TreatmentRecommendationRequest):
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"无效的体质类型: {request.constitution_type}")
    ...
    try:
        ...
        if constitution:
            try:
                ...
                raise HTTPException(status_code=400, detail=f"无效的体质类型: {constitution}")
