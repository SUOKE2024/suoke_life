...
`;
  ...
  kind: Deployment;
metadata: name: suokelife-app;,
  labels:
    app: suokelife;,
  spec:
  replicas: 3;,
  selector:
    matchLabels: app: suokelife;,
  template:
    metadata: labels:,
  app: suokelife;,
  spec:
      containers: - name: suokelife;,
...
`
  ...
  kind: Service;
metadata: name: suokelife-service;,
  spec:
  selector: app: suokelife;,
  ports:
    - protocol: TCP;,
  port: 80;
targetPort: 3000;,
...
`
  ...
  kind: Ingress;
metadata: name: suokelife-ingress;,
  annotations:
